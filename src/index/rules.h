...
inline constexpr DeltaRuleSet<INDEX_LEAF_RULES, 8, 5, 2> INDEX_RULES{
    .leaves = {{
        ...
        {.action = ACTION_CONVERSION_DRAFT4,
         .base = 0,
         .filename = "bundle-draft4.metapack",
        ...
        {.action = ACTION_CONVERSION_DRAFT6,
         .base = 0,
         .filename = "bundle-draft6.metapack",
         .gate = TargetGate::IfSelected,
         .dirty = DirtyOverride::Normal,
         .is_root = false,
         .combine_only = false,
        ...
        {.action = ACTION_CONVERSION_DRAFT7,
         .base = 0,
         .filename = "bundle-draft7.metapack",
         .gate = TargetGate::IfSelected,
         .dirty = DirtyOverride::Normal,
         .is_root = false,
         .combine_only = false,
        ...
        {.action = ACTION_CONVERSION_2019_09,
         .base = 0,
         .filename = "bundle-2019-09.metapack",
         .gate = TargetGate::IfSelected,
         .dirty = DirtyOverride::Normal,
         .is_root = false,
         .combine_only = false,
        ...
        {.action = ACTION_CONVERSION_2020_12,
         .base = 0,
         .filename = "bundle-2020-12.metapack",
         .gate = TargetGate::IfSelected,
         .dirty = DirtyOverride::Normal,
         .is_root = false,
         .combine_only = false,
    ...
    .directories = {{{.name = "schemas", .namespaced = false},
                     {.name = "explorer", .namespaced = true}}},
    .sentinel = "%",
