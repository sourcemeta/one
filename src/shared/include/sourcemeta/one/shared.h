...
constexpr auto HANDLER_ROOT = 1;
constexpr auto HANDLER_SELF_V1_API_LIST = 2;
constexpr auto HANDLER_SELF_V1_API_LIST_PATH = 3;
constexpr auto HANDLER_SELF_V1_API_SCHEMAS_DEPENDENCIES = 4;
