#ifndef SOURCEMETA_ONE_ENTERPRISE_SERVER_H_
#define SOURCEMETA_ONE_ENTERPRISE_SERVER_H_

#include <sourcemeta/one/enterprise_server_action_auth_callback_v1.h>
...
#include <sourcemeta/one/enterprise_server_action_mcp_protected_resource_metadata_v1.h>
