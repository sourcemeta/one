...
TEST(Build_delta, full_empty_registry) {
  ...
  EXPECT_ACTION(plan, 2, 1, 2, DirectoryList,
...
TEST(Build_delta, full_single_schema) {
  ...
  EXPECT_ACTION(plan, 2, 0, 2, WebNotFound,
                output / "explorer" / "%" / "404.metapack", "",
                output / "configuration.json");
  EXPECT_ACTION(plan, 2, 1, 2, Materialise,
  ...
  EXPECT_ACTION(plan, 5, 0, 4, SchemaMetadata,
                ...
                output / "schemas" / "foo" / "%" / "dependencies.metapack",
                output / "schemas" / "foo" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 5, 1, 4, BlazeExhaustive,
  ...
  EXPECT_ACTION(plan, 6, 0, 2, DirectoryList,
                output / "explorer" / "%" / "directory.metapack", "",
                output / "explorer" / "foo" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 6, 1, 2, WebSchema,
...
TEST(Build_delta, full_stale_file_in_entries) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Full, 10, 21);
  ...
  EXPECT_ACTION(plan, 9, 0, 1, Remove, output / "schemas" / "ghost", "");
...
TEST(Build_delta, full_without_comment_removes_existing) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Full, 6, 9);
  ...
  EXPECT_ACTION(plan, 5, 0, 1, Remove, output / "comment.json", "");
...
TEST(Build_delta, incremental_with_comment) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Full, 9, 18);

  EXPECT_ACTION(plan, 0, 0, 1, Comment, output / "comment.json", "Hello world");

  EXPECT_ACTION(plan, 2, 0, 1, Materialise,
                output / "schemas" / "foo" / "%" / "schema.metapack",
                "https://example.com/foo",
                std::filesystem::path{"/"} / "src" / "foo.json",
                output / "configuration.json");
...
TEST(Build_delta, incremental_empty_comment_removes_existing) {
  ...
  EXPECT_ACTION(plan, 8, 0, 1, Remove, output / "comment.json", "");
...
TEST(Build_delta, full_config_change_to_empty_schemas) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Full, 6, 10);
  ...
  EXPECT_ACTION(plan, 5, 0, 2, Remove, output / "explorer" / "foo", "");
  EXPECT_ACTION(plan, 5, 1, 2, Remove, output / "schemas", "");
...
TEST(Build_delta, full_single_schema_evaluate_false) {
  ...
  EXPECT_ACTION(plan, 5, 0, 2, SchemaMetadata,
                output / "explorer" / "foo" / "%" / "schema.metapack",
                "https://example.com/foo",
                output / "schemas" / "foo" / "%" / "schema.metapack",
                output / "schemas" / "foo" / "%" / "health.metapack",
                output / "schemas" / "foo" / "%" / "dependencies.metapack",
                output / "schemas" / "foo" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 5, 1, 2, Editor,
                output / "schemas" / "foo" / "%" / "editor.metapack",
                "https://example.com/foo",
                output / "schemas" / "foo" / "%" / "bundle.metapack");
...
TEST(Build_delta, full_evaluate_false_removes_existing_blaze) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Full, 10, 20);
  ...
  EXPECT_ACTION(plan, 9, 0, 2, Remove,
                output / "schemas" / "foo" / "%" / "blaze-exhaustive.metapack",
                "");
  EXPECT_ACTION(plan, 9, 1, 2, Remove,
                output / "schemas" / "foo" / "%" / "blaze-fast.metapack", "");
...
TEST(Build_delta, incremental_evaluate_false) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Full, 8, 15);
...
TEST(Build_delta, incremental_missing_bundle) {
  ...
  EXPECT_ACTION(plan, 0, 0, 1, Bundle,
                output / "schemas" / "foo" / "%" / "bundle.metapack",
                "https://example.com/foo",
                output / "schemas" / "foo" / "%" / "schema.metapack",
                output / "schemas" / "foo" / "%" / "dependencies.metapack");

  EXPECT_ACTION(plan, 1, 0, 4, SchemaMetadata,
                output / "explorer" / "foo" / "%" / "schema.metapack",
                "https://example.com/foo",
                output / "schemas" / "foo" / "%" / "schema.metapack",
                output / "schemas" / "foo" / "%" / "health.metapack",
  ...
  EXPECT_ACTION(plan, 2, 0, 2, DirectoryList,
                output / "explorer" / "%" / "directory.metapack", "",
                output / "explorer" / "foo" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 1, 2, WebSchema,
                output / "explorer" / "foo" / "%" / "schema-html.metapack",
                "https://example.com/foo",
                output / "explorer" / "foo" / "%" / "schema.metapack",
                output / "schemas" / "foo" / "%" / "health.metapack");
...
TEST(Build_delta, incremental_reverse_dep_direct) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Full, 8, 29);

  EXPECT_ACTION(plan, 1, 0, 2, Materialise,
  ...
  EXPECT_ACTION_UNORDERED(plan, 5, 0, 3, DirectoryList,
                          output / "explorer" / "%" / "directory.metapack", "",
                          output / "explorer" / "a" / "%" / "schema.metapack",
                          output / "explorer" / "b" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 5, 1, 3, WebSchema,
...
TEST(Build_delta, incremental_reverse_dep_transitive) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Full, 8, 41);

  EXPECT_ACTION(plan, 1, 0, 3, Materialise,
                output / "schemas" / "a" / "%" / "schema.metapack",
                "https://example.com/a",
                std::filesystem::path{"/"} / "src" / "a.json",
                output / "configuration.json");
  EXPECT_ACTION(plan, 1, 1, 3, Materialise,
                ...
                std::filesystem::path{"/"} / "src" / "b.json",
                output / "configuration.json");
  EXPECT_ACTION(plan, 1, 2, 3, Materialise,
                output / "schemas" / "c" / "%" / "schema.metapack",
                "https://example.com/c",
                std::filesystem::path{"/"} / "src" / "c.json",
                output / "configuration.json");

  EXPECT_ACTION(plan, 2, 0, 12, Dependencies,
                output / "schemas" / "a" / "%" / "dependencies.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 1, 12, Locations,
                output / "schemas" / "a" / "%" / "locations.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 2, 12, Positions,
                output / "schemas" / "a" / "%" / "positions.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 3, 12, Stats,
                output / "schemas" / "a" / "%" / "stats.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 4, 12, Dependencies,
                output / "schemas" / "b" / "%" / "dependencies.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 5, 12, Locations,
                output / "schemas" / "b" / "%" / "locations.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 6, 12, Positions,
                output / "schemas" / "b" / "%" / "positions.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 7, 12, Stats,
                output / "schemas" / "b" / "%" / "stats.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 8, 12, Dependencies,
                output / "schemas" / "c" / "%" / "dependencies.metapack",
                "https://example.com/c",
                output / "schemas" / "c" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 9, 12, Locations,
                output / "schemas" / "c" / "%" / "locations.metapack",
                "https://example.com/c",
                output / "schemas" / "c" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 10, 12, Positions,
                output / "schemas" / "c" / "%" / "positions.metapack",
                "https://example.com/c",
                output / "schemas" / "c" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 11, 12, Stats,
                output / "schemas" / "c" / "%" / "stats.metapack",
                "https://example.com/c",
                output / "schemas" / "c" / "%" / "schema.metapack");

  EXPECT_ACTION(plan, 3, 0, 6, Bundle,
                output / "schemas" / "a" / "%" / "bundle.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack",
                output / "schemas" / "a" / "%" / "dependencies.metapack");
  EXPECT_ACTION(plan, 3, 1, 6, Health,
                output / "schemas" / "a" / "%" / "health.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack",
                output / "schemas" / "a" / "%" / "dependencies.metapack");
  EXPECT_ACTION(plan, 3, 2, 6, Bundle,
                output / "schemas" / "b" / "%" / "bundle.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "schema.metapack",
                output / "schemas" / "b" / "%" / "dependencies.metapack");
  EXPECT_ACTION(plan, 3, 3, 6, Health,
                output / "schemas" / "b" / "%" / "health.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "schema.metapack",
                output / "schemas" / "b" / "%" / "dependencies.metapack");
  EXPECT_ACTION(plan, 3, 4, 6, Bundle,
                output / "schemas" / "c" / "%" / "bundle.metapack",
                "https://example.com/c",
                output / "schemas" / "c" / "%" / "schema.metapack",
                output / "schemas" / "c" / "%" / "dependencies.metapack");
  EXPECT_ACTION(plan, 3, 5, 6, Health,
                output / "schemas" / "c" / "%" / "health.metapack",
                "https://example.com/c",
                output / "schemas" / "c" / "%" / "schema.metapack",
                output / "schemas" / "c" / "%" / "dependencies.metapack");

  EXPECT_ACTION(plan, 4, 0, 12, SchemaMetadata,
                output / "explorer" / "a" / "%" / "schema.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack",
                output / "schemas" / "a" / "%" / "health.metapack",
                output / "schemas" / "a" / "%" / "dependencies.metapack",
                output / "schemas" / "a" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 1, 12, SchemaMetadata,
                output / "explorer" / "b" / "%" / "schema.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "schema.metapack",
                output / "schemas" / "b" / "%" / "health.metapack",
                output / "schemas" / "b" / "%" / "dependencies.metapack",
                output / "schemas" / "b" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 2, 12, SchemaMetadata,
                ...
                output / "schemas" / "c" / "%" / "dependencies.metapack",
                output / "schemas" / "c" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 3, 12, BlazeExhaustive,
                output / "schemas" / "a" / "%" / "blaze-exhaustive.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 4, 12, BlazeFast,
                output / "schemas" / "a" / "%" / "blaze-fast.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 5, 12, Editor,
                output / "schemas" / "a" / "%" / "editor.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 6, 12, BlazeExhaustive,
                output / "schemas" / "b" / "%" / "blaze-exhaustive.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 7, 12, BlazeFast,
                output / "schemas" / "b" / "%" / "blaze-fast.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 8, 12, Editor,
                output / "schemas" / "b" / "%" / "editor.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 9, 12, BlazeExhaustive,
                output / "schemas" / "c" / "%" / "blaze-exhaustive.metapack",
                "https://example.com/c",
                output / "schemas" / "c" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 10, 12, BlazeFast,
                output / "schemas" / "c" / "%" / "blaze-fast.metapack",
                "https://example.com/c",
                output / "schemas" / "c" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 11, 12, Editor,
                output / "schemas" / "c" / "%" / "editor.metapack",
                "https://example.com/c",
                output / "schemas" / "c" / "%" / "bundle.metapack");

  EXPECT_ACTION_UNORDERED(plan, 5, 0, 4, DirectoryList,
                          output / "explorer" / "%" / "directory.metapack", "",
                          output / "explorer" / "a" / "%" / "schema.metapack",
                          output / "explorer" / "b" / "%" / "schema.metapack",
                          output / "explorer" / "c" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 5, 1, 4, WebSchema,
                ...
                output / "explorer" / "a" / "%" / "schema.metapack",
                output / "schemas" / "a" / "%" / "health.metapack");
  EXPECT_ACTION(plan, 5, 2, 4, WebSchema,
                output / "explorer" / "b" / "%" / "schema-html.metapack",
                "https://example.com/b",
                output / "explorer" / "b" / "%" / "schema.metapack",
                output / "schemas" / "b" / "%" / "health.metapack");
...
TEST(Build_delta, mtime_reverse_dep) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Full, 8, 28);

  EXPECT_ACTION(plan, 1, 0, 5, Materialise,
                output / "schemas" / "a" / "%" / "schema.metapack",
                "https://example.com/a",
                std::filesystem::path{"/"} / "src" / "a.json",
                output / "configuration.json");
  EXPECT_ACTION(plan, 1, 1, 5, Dependencies,
                output / "schemas" / "b" / "%" / "dependencies.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 1, 2, 5, Locations,
                output / "schemas" / "b" / "%" / "locations.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 1, 3, 5, Positions,
                output / "schemas" / "b" / "%" / "positions.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 1, 4, 5, Stats,
                output / "schemas" / "b" / "%" / "stats.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "schema.metapack");

  EXPECT_ACTION(plan, 2, 0, 6, Dependencies,
                output / "schemas" / "a" / "%" / "dependencies.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 1, 6, Locations,
                output / "schemas" / "a" / "%" / "locations.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 2, 6, Positions,
                output / "schemas" / "a" / "%" / "positions.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack");
  EXPECT_ACTION(plan, 2, 3, 6, Stats,
                output / "schemas" / "a" / "%" / "stats.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack");
  ...
  EXPECT_ACTION(plan, 3, 0, 6, SchemaMetadata,
                ...
                output / "schemas" / "b" / "%" / "dependencies.metapack",
                output / "schemas" / "b" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 3, 1, 6, Bundle,
                output / "schemas" / "a" / "%" / "bundle.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack",
                output / "schemas" / "a" / "%" / "dependencies.metapack");
  EXPECT_ACTION(plan, 3, 2, 6, Health,
                output / "schemas" / "a" / "%" / "health.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack",
                output / "schemas" / "a" / "%" / "dependencies.metapack");
  EXPECT_ACTION(plan, 3, 3, 6, BlazeExhaustive,
                output / "schemas" / "b" / "%" / "blaze-exhaustive.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 3, 4, 6, BlazeFast,
                output / "schemas" / "b" / "%" / "blaze-fast.metapack",
                "https://example.com/b",
                output / "schemas" / "b" / "%" / "bundle.metapack");
  ...
  EXPECT_ACTION(plan, 4, 0, 5, SchemaMetadata,
                output / "explorer" / "a" / "%" / "schema.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "schema.metapack",
                output / "schemas" / "a" / "%" / "health.metapack",
                output / "schemas" / "a" / "%" / "dependencies.metapack",
                output / "schemas" / "a" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 1, 5, WebSchema,
                output / "explorer" / "b" / "%" / "schema-html.metapack",
                "https://example.com/b",
                output / "explorer" / "b" / "%" / "schema.metapack",
                output / "schemas" / "b" / "%" / "health.metapack");
  EXPECT_ACTION(plan, 4, 2, 5, BlazeExhaustive,
                output / "schemas" / "a" / "%" / "blaze-exhaustive.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "bundle.metapack");
  EXPECT_ACTION(plan, 4, 3, 5, BlazeFast,
                output / "schemas" / "a" / "%" / "blaze-fast.metapack",
                "https://example.com/a",
                output / "schemas" / "a" / "%" / "bundle.metapack");
...
TEST(Build_delta, incremental_evaluate_false_removes_existing_blaze) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Full, 9, 17);
...
TEST(Build_delta, headless_full_empty_registry) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Headless, 5, 6);

  EXPECT_ACTION(plan, 0, 0, 2, Configuration, output / "configuration.json",
                "");
  EXPECT_ACTION(plan, 0, 1, 2, Version, output / "version.json", "1.0.0");

  EXPECT_ACTION(plan, 2, 0, 1, DirectoryList,
                output / "explorer" / "%" / "directory.metapack", "");
...
TEST(Build_delta, headless_incremental) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Headless, 7, 14);
...
TEST(Build_delta, full_to_headless_removes_web) {
  ...
  EXPECT_ACTION(plan, 8, 0, 4, Remove,
                output / "explorer" / "%" / "404.metapack", "");
  EXPECT_ACTION(plan, 8, 1, 4, Remove,
                output / "explorer" / "%" / "directory-html.metapack", "");
  EXPECT_ACTION(plan, 8, 2, 4, Remove,
                output / "explorer" / "foo" / "%" / "directory-html.metapack",
                "");
  EXPECT_ACTION(plan, 8, 3, 4, Remove,
                output / "explorer" / "foo" / "%" / "schema-html.metapack", "");
...
TEST(Build_delta, full_to_headless_full_rebuild) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Headless, 10, 20);
  ...
  EXPECT_ACTION(plan, 9, 0, 3, Remove,
                output / "explorer" / "%" / "404.metapack", "");
  EXPECT_ACTION(plan, 9, 1, 3, Remove,
                output / "explorer" / "%" / "directory-html.metapack", "");
  EXPECT_ACTION(plan, 9, 2, 3, Remove,
                output / "explorer" / "foo" / "%" / "schema-html.metapack", "");
...
TEST(Build_delta, full_single_schema_nested_path_headless) {
  ...
  EXPECT_CONSISTENT_PLAN(plan, entries, output, Headless, 10, 18);
  ...
  EXPECT_ACTION(plan, 7, 0, 1, DirectoryList,
                output / "explorer" / "%" / "directory.metapack", "",
                output / "explorer" / "example" / "%" / "directory.metapack");
