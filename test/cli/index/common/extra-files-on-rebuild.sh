...
(  9%) Producing: schemas/example/schemas/old/%/locations.metapack
...
( 55%) Producing: schemas/example/schemas/old/%/blaze-fast.metapack
( 55%) Producing: schemas/example/schemas/old/%/editor.metapack
...
(  7%) Combining: schemas/example/schemas/old/%/dependents.metapack
