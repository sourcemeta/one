...
( 36%) Producing: schemas/example/schemas/old/%/bundle.metapack
( 36%) Producing: schemas/example/schemas/old/%/health.metapack
...
( 58%) Producing: schemas/example/schemas/old/%/blaze-exhaustive.metapack
( 58%) Producing: schemas/example/schemas/old/%/blaze-fast.metapack
( 58%) Producing: schemas/example/schemas/old/%/editor.metapack
...
( 79%) Producing: explorer/example/schemas/old/%/schema-html.metapack
...
(  2%) Combining: schemas/example/schemas/old/%/dependents.metapack
