...
(  1%) Producing: schemas/example/schemas/old/%/schema.metapack
...
( 51%) Producing: explorer/example/schemas/old/%/schema.metapack
...
(  3%) Combining: schemas/example/schemas/old/%/dependents.metapack
