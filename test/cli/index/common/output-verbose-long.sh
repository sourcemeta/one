...
https://sourcemeta.com/api/auth/login/response => https://sourcemeta.com/self/v1/schemas/api/auth/login/response
...
( 52%) Producing: explorer/public/example/schemas/foo/%/schema.metapack
...
( 81%) Producing: explorer/public/example/schemas/foo/%/schema-html.metapack
