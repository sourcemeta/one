...
( 30%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/positions.metapack
...
( 34%) Producing: schemas/self/v1/schemas/mcp/ping/response/%/stats.metapack
...
( 67%) Producing: schemas/self/v1/schemas/api/schemas/positions/response/%/blaze-exhaustive.metapack
...
( 68%) Producing: schemas/self/v1/schemas/api/schemas/search/response/%/blaze-exhaustive.metapack
( 68%) Producing: schemas/self/v1/schemas/api/schemas/search/response/%/blaze-fast.metapack
( 68%) Producing: schemas/self/v1/schemas/api/schemas/search/response/%/editor.metapack
( 69%) Producing: schemas/self/v1/schemas/api/schemas/stats/response/%/blaze-exhaustive.metapack
( 69%) Producing: schemas/self/v1/schemas/api/schemas/stats/response/%/blaze-fast.metapack
...
( 72%) Producing: schemas/self/v1/schemas/mcp/initialize/request/%/blaze-fast.metapack
...
( 73%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/blaze-fast.metapack
...
( 87%) Producing: explorer/self/v1/schemas/mcp/error/%/schema-html.metapack
