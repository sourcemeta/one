...
(  0%) Producing: explorer/public/%/login-html.metapack
...
(  5%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/request/%/schema.metapack
...
( 20%) Producing: schemas/self/v1/schemas/mcp/prm/response/%/stats.metapack
...
( 35%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/request/%/dependencies.metapack
...
( 37%) Producing: schemas/self/v1/schemas/mcp/tools/list/request/%/locations.metapack
...
( 45%) Producing: schemas/self/v1/schemas/mcp/resources/read/request/%/health.metapack
...
( 47%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/bundle.metapack
...
( 48%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/health.metapack
...
( 50%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/bundle.metapack
...
( 52%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/health.metapack
...
( 54%) Producing: explorer/public/self/v1/schemas/api/schemas/positions/response/%/schema.metapack
...
( 56%) Producing: explorer/public/self/v1/schemas/mcp/resources/list/response/%/schema.metapack
...
( 57%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/schema.metapack
...
( 58%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/schema.metapack
( 58%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/schema.metapack
...
( 59%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/request/%/schema.metapack
...
( 60%) Producing: schemas/schemas/test/%/blaze-exhaustive.metapack
...
( 73%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/blaze-exhaustive.metapack
...
( 74%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/blaze-exhaustive.metapack
...
( 75%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/editor.metapack
...
( 76%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/editor.metapack
...
( 78%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/blaze-fast.metapack
...
( 79%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/response/%/blaze-exhaustive.metapack
( 79%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/response/%/blaze-fast.metapack
...
( 80%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/request/%/blaze-exhaustive.metapack
...
( 81%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/editor.metapack
( 81%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/blaze-exhaustive.metapack
...
( 82%) Producing: schemas/self/v1/schemas/mcp/tools/list/response/%/editor.metapack
( 82%) Producing: explorer/public/schemas/%/directory.metapack
...
( 83%) Producing: explorer/public/self/v1/schemas/api/schemas/dependents/%/directory.metapack
...
( 86%) Producing: explorer/public/self/v1/schemas/mcp/initialize/%/directory.metapack
...
( 87%) Producing: explorer/public/self/v1/schemas/mcp/prm/%/directory.metapack
...
( 88%) Producing: explorer/public/self/v1/schemas/mcp/resources/read/response/%/schema-html.metapack
...
( 89%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/schema-html.metapack
...
( 90%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/%/directory.metapack
( 90%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/schema-html.metapack
...
( 91%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/%/directory.metapack
...
( 92%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/list-directory/response/%/schema-html.metapack
( 92%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/request/%/schema-html.metapack
...
( 93%) Producing: explorer/public/self/v1/schemas/mcp/tools/list/%/directory.metapack
( 93%) Producing: explorer/public/self/v1/schemas/mcp/tools/list/request/%/schema-html.metapack
...
( 96%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/%/directory.metapack
