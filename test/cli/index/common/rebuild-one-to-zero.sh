...
( 51%) Producing: explorer/self/v1/schemas/api/schemas/metadata/response/%/schema.metapack
...
( 52%) Producing: explorer/self/v1/schemas/api/schemas/trace/response/%/schema.metapack
...
( 78%) Producing: explorer/schemas/test/%/schema-html.metapack
...
( 79%) Producing: explorer/self/v1/schemas/api/schemas/dependents/response/%/schema-html.metapack
...
( 80%) Producing: explorer/self/v1/schemas/api/schemas/metadata/response/%/schema-html.metapack
...
( 81%) Producing: explorer/self/v1/schemas/api/schemas/search/response/%/schema-html.metapack
...
( 82%) Producing: explorer/self/v1/schemas/mcp/initialize/response/%/schema-html.metapack
...
( 83%) Producing: explorer/self/v1/schemas/mcp/request/%/schema-html.metapack
...
( 84%) Producing: explorer/self/v1/schemas/mcp/resources/templates/list/response/%/schema-html.metapack
...
( 88%) Producing: explorer/schemas/%/login-html.metapack
( 89%) Producing: explorer/self/v1/schemas/api/list/%/directory-html.metapack
( 89%) Producing: explorer/self/v1/schemas/api/list/%/login-html.metapack
...
( 91%) Producing: explorer/self/v1/schemas/api/schemas/rdf/%/login-html.metapack
...
( 92%) Producing: explorer/self/v1/schemas/mcp/notifications/%/directory-html.metapack
...
( 93%) Producing: explorer/self/v1/schemas/mcp/resources/read/%/login-html.metapack
...
( 94%) Producing: explorer/self/v1/schemas/mcp/tools/call/get-schema-dependents/%/directory-html.metapack
...
(  1%) Combining: explorer/schemas/test/%/dependents.metapack
...
( 14%) Producing: explorer/%/directory.metapack
( 28%) Producing: explorer/%/directory-html.metapack
( 42%) Producing: explorer/%/login-html.metapack
( 57%) Producing: explorer/%/search.metapack
( 71%) Producing: explorer/%/mcp.metapack
( 85%) Disposing: explorer/schemas
