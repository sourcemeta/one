...
(  9%) Producing: schemas/schemas/test/%/locations.metapack
(  9%) Producing: schemas/schemas/test/%/positions.metapack
( 10%) Producing: schemas/schemas/test/%/stats.metapack
...
( 48%) Producing: explorer/schemas/test/%/schema.metapack
...
( 56%) Producing: schemas/schemas/test/%/editor.metapack
...
( 75%) Producing: explorer/schemas/%/directory.metapack
...
(  7%) Combining: schemas/schemas/test/%/dependents.metapack
