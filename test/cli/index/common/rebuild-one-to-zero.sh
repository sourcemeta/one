...
( 13%) Producing: schemas/self/v1/schemas/api/schemas/dependents/rpc/%/locations.metapack
...
( 15%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/rpc/%/locations.metapack
...
( 61%) Producing: schemas/self/v1/schemas/api/error/%/editor.metapack
...
( 62%) Producing: schemas/self/v1/schemas/api/list/rpc/%/editor.metapack
...
( 63%) Producing: schemas/self/v1/schemas/api/schemas/dependencies/rpc/%/editor.metapack
...
( 82%) Producing: explorer/schemas/%/directory.metapack
...
( 83%) Producing: explorer/self/v1/schemas/api/list/%/directory.metapack
...
( 93%) Producing: explorer/schemas/%/directory-html.metapack
