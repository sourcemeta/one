...
( 38%) Producing: schemas/schemas/test/%/bundle.metapack
...
( 52%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/health.metapack
...
( 61%) Producing: schemas/self/v1/schemas/api/error/%/blaze-fast.metapack
...
( 81%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/blaze-exhaustive.metapack
...
( 82%) Producing: schemas/self/v1/schemas/mcp/tools/list/request/%/editor.metapack
...
( 83%) Producing: explorer/self/v1/schemas/api/error/%/schema-html.metapack
...
( 93%) Producing: explorer/self/v1/schemas/mcp/tools/list/request/%/schema-html.metapack
...
( 94%) Producing: explorer/self/v1/schemas/api/schemas/dependents/%/directory-html.metapack
