...
( 21%) Producing: schemas/self/v1/schemas/api/schemas/trace/request/%/dependencies.metapack
...
( 23%) Producing: schemas/self/v1/schemas/mcp/error/%/dependencies.metapack
...
( 68%) Producing: schemas/self/v1/schemas/api/schemas/trace/request/%/blaze-exhaustive.metapack
...
(  3%) Combining: schemas/schemas/test/%/dependents.metapack
(  6%) Combining: schemas/self/v1/schemas/api/error/%/dependents.metapack
(  9%) Combining: schemas/self/v1/schemas/api/list/response/%/dependents.metapack
( 12%) Combining: schemas/self/v1/schemas/api/schemas/dependencies/response/%/dependents.metapack
...
( 32%) Combining: schemas/self/v1/schemas/api/schemas/metadata/response/%/dependents.metapack
( 35%) Combining: schemas/self/v1/schemas/api/schemas/position/%/dependents.metapack
( 38%) Combining: schemas/self/v1/schemas/api/schemas/positions/response/%/dependents.metapack
( 41%) Combining: schemas/self/v1/schemas/api/schemas/search/response/%/dependents.metapack
( 45%) Combining: schemas/self/v1/schemas/api/schemas/stats/response/%/dependents.metapack
( 48%) Combining: schemas/self/v1/schemas/api/schemas/trace/request/%/dependents.metapack
( 51%) Combining: schemas/self/v1/schemas/api/schemas/trace/response/%/dependents.metapack
( 54%) Combining: schemas/self/v1/schemas/mcp/error/%/dependents.metapack
( 58%) Combining: schemas/self/v1/schemas/mcp/initialize/request/%/dependents.metapack
( 61%) Combining: schemas/self/v1/schemas/mcp/initialize/response/%/dependents.metapack
( 64%) Combining: schemas/self/v1/schemas/mcp/notifications/cancelled/%/dependents.metapack
( 67%) Combining: schemas/self/v1/schemas/mcp/notifications/initialized/%/dependents.metapack
( 70%) Combining: schemas/self/v1/schemas/mcp/ping/request/%/dependents.metapack
( 74%) Combining: schemas/self/v1/schemas/mcp/ping/response/%/dependents.metapack
...
( 87%) Combining: schemas/self/v1/schemas/mcp/resources/read/request/%/dependents.metapack
