...
( 41%) Producing: schemas/self/v1/schemas/api/schemas/rdf/request/%/bundle.metapack
...
( 43%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/health.metapack
...
( 66%) Producing: schemas/self/v1/schemas/api/schemas/stats/response/%/editor.metapack
...
( 67%) Producing: schemas/self/v1/schemas/mcp/error/%/editor.metapack
...
( 68%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/blaze-fast.metapack
...
( 69%) Producing: schemas/self/v1/schemas/mcp/ping/response/%/blaze-exhaustive.metapack
...
( 85%) Producing: explorer/self/v1/schemas/api/schemas/rdf/response/%/schema-html.metapack
...
( 89%) Producing: explorer/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/schema-html.metapack
...
( 97%) Producing: explorer/self/v1/schemas/mcp/tools/call/instance-to-rdf/%/directory-html.metapack
