...
( 52%) Producing: explorer/public/example/schemas/old/%/schema.metapack
...
( 53%) Producing: explorer/public/self/v1/schemas/api/schemas/rdf/request/%/schema.metapack
...
( 54%) Producing: explorer/public/self/v1/schemas/mcp/notifications/cancelled/%/schema.metapack
...
( 55%) Producing: explorer/public/self/v1/schemas/mcp/resources/read/request/%/schema.metapack
...
( 56%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/schema.metapack
...
( 57%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/schema.metapack
...
( 58%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/response/%/schema.metapack
...
( 81%) Producing: explorer/public/example/schemas/%/directory.metapack
( 81%) Producing: explorer/public/example/schemas/old/%/schema-html.metapack
...
( 84%) Producing: explorer/public/self/v1/schemas/api/schemas/search/response/%/schema-html.metapack
...
( 85%) Producing: explorer/public/self/v1/schemas/mcp/initialize/response/%/schema-html.metapack
...
( 86%) Producing: explorer/public/self/v1/schemas/mcp/prm/response/%/schema-html.metapack
...
( 87%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/list/request/%/schema-html.metapack
...
( 88%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/schema-html.metapack
( 88%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/%/directory.metapack
...
( 89%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/schema-html.metapack
...
( 90%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/schema-html.metapack
...
( 91%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/response/%/schema-html.metapack
( 91%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/%/directory.metapack
...
( 92%) Producing: explorer/public/self/v1/schemas/mcp/tools/list/response/%/schema-html.metapack
( 92%) Producing: explorer/public/example/%/directory.metapack
( 93%) Producing: explorer/public/example/schemas/%/directory-html.metapack
...
( 95%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/%/directory-html.metapack
...
( 97%) Producing: explorer/public/example/%/directory-html.metapack
...
( 36%) Producing: explorer/public/example/schemas/new/%/schema.metapack
...
( 54%) Producing: explorer/public/example/schemas/%/directory.metapack
( 59%) Producing: explorer/public/example/schemas/new/%/schema-html.metapack
( 63%) Producing: explorer/public/example/%/directory.metapack
( 68%) Producing: explorer/public/example/schemas/%/directory-html.metapack
( 72%) Producing: explorer/public/%/directory.metapack
( 77%) Producing: explorer/public/example/%/directory-html.metapack
( 81%) Producing: explorer/public/%/directory-html.metapack
( 86%) Producing: explorer/public/%/search.metapack
( 90%) Producing: explorer/public/%/mcp.metapack
( 95%) Disposing: explorer/public/example/schemas/old
