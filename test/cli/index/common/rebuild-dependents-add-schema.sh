...
grep -q "explorer/public/example/schemas/a/%/dependents.metapack" \
    "$TMP/output_producing.txt"

# D's dependents must rebuild (D is new)
grep -q "explorer/public/example/schemas/d/%/dependents.metapack" \
    "$TMP/output_producing.txt"

# B and C's dependents must NOT rebuild (unrelated to D)
grep -q "explorer/public/example/schemas/b/%/dependents.metapack" \
    "$TMP/output_producing.txt" && exit 1
grep -q "explorer/public/example/schemas/c/%/dependents.metapack" \
    "$TMP/output_producing.txt" && exit 1
...
./explorer/public/example/schemas/a/%/schema-html.metapack
./explorer/public/example/schemas/a/%/schema.metapack
./explorer/public/example/schemas/b
./explorer/public/example/schemas/b/%
./explorer/public/example/schemas/b/%/dependents.metapack
./explorer/public/example/schemas/b/%/schema-html.metapack
./explorer/public/example/schemas/b/%/schema.metapack
./explorer/public/example/schemas/c
./explorer/public/example/schemas/c/%
./explorer/public/example/schemas/c/%/dependents.metapack
./explorer/public/example/schemas/c/%/schema-html.metapack
./explorer/public/example/schemas/c/%/schema.metapack
./explorer/public/example/schemas/d
./explorer/public/example/schemas/d/%
./explorer/public/example/schemas/d/%/dependents.metapack
./explorer/public/example/schemas/d/%/schema-html.metapack
./explorer/public/example/schemas/d/%/schema.metapack
