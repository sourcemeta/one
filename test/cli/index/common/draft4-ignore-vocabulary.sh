...
( 49%) Producing: explorer/example/schemas/test/%/schema.metapack
...
( 56%) Producing: schemas/example/schemas/test/%/blaze-exhaustive.metapack
( 57%) Producing: schemas/example/schemas/test/%/blaze-fast.metapack
( 57%) Producing: schemas/example/schemas/test/%/editor.metapack
...
( 77%) Producing: explorer/example/schemas/test/%/schema-html.metapack
