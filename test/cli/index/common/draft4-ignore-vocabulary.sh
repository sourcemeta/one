...
( 36%) Producing: schemas/example/schemas/test/%/bundle.metapack
( 36%) Producing: schemas/example/schemas/test/%/health.metapack
...
( 50%) Producing: explorer/example/schemas/test/%/schema.metapack
...
( 58%) Producing: schemas/example/schemas/test/%/blaze-exhaustive.metapack
( 58%) Producing: schemas/example/schemas/test/%/blaze-fast.metapack
( 58%) Producing: schemas/example/schemas/test/%/editor.metapack
...
( 79%) Producing: explorer/example/schemas/test/%/schema-html.metapack
...
(  2%) Combining: schemas/example/schemas/test/%/dependents.metapack
