...
( 60%) Producing: schemas/example/schemas/test/%/blaze-exhaustive.metapack
( 60%) Producing: schemas/example/schemas/test/%/blaze-fast.metapack
...
( 82%) Producing: explorer/example/schemas/test/%/schema-html.metapack
