...
(  9%) Producing: schemas/example/schemas/test/%/locations.metapack
...
( 35%) Producing: schemas/example/schemas/test/%/bundle.metapack
( 35%) Producing: schemas/example/schemas/test/%/health.metapack
...
( 48%) Producing: explorer/example/schemas/test/%/schema.metapack
...
( 54%) Producing: schemas/example/schemas/test/%/blaze-exhaustive.metapack
( 55%) Producing: schemas/example/schemas/test/%/blaze-fast.metapack
( 55%) Producing: schemas/example/schemas/test/%/editor.metapack
...
( 75%) Producing: explorer/example/schemas/test/%/schema-html.metapack
...
(  7%) Combining: schemas/example/schemas/test/%/dependents.metapack
