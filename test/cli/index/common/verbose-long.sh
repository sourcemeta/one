...
( 77%) Producing: schemas/self/v1/schemas/mcp/ping/response/%/blaze-fast.metapack
...
( 78%) Producing: schemas/self/v1/schemas/mcp/resources/list/request/%/blaze-fast.metapack
...
( 79%) Producing: schemas/self/v1/schemas/mcp/resources/read/request/%/blaze-exhaustive.metapack
( 79%) Producing: schemas/self/v1/schemas/mcp/resources/read/request/%/blaze-fast.metapack
...
( 80%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/request/%/blaze-exhaustive.metapack
( 80%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/request/%/blaze-fast.metapack
...
( 81%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/editor.metapack
( 81%) Producing: schemas/self/v1/schemas/mcp/response/%/blaze-exhaustive.metapack
