...
(  2%) Resolving: example/schemas/foo.json
...
( 53%) Producing: explorer/self/v1/schemas/api/schemas/positions/rpc/request/%/schema.metapack
...
( 54%) Producing: explorer/self/v1/schemas/api/schemas/trace/rpc/request/%/schema.metapack
...
( 58%) Producing: schemas/example/schemas/foo/%/blaze-exhaustive.metapack
...
( 59%) Producing: schemas/self/v1/schemas/api/list/rpc/request/%/editor.metapack
...
( 62%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/rpc/request/%/blaze-fast.metapack
...
( 63%) Producing: schemas/self/v1/schemas/api/schemas/health/rpc/request/%/blaze-fast.metapack
...
( 64%) Producing: schemas/self/v1/schemas/api/schemas/locations/rpc/request/%/blaze-fast.metapack
( 64%) Producing: schemas/self/v1/schemas/api/schemas/locations/rpc/request/%/editor.metapack
...
( 65%) Producing: schemas/self/v1/schemas/api/schemas/metadata/rpc/request/%/editor.metapack
...
( 66%) Producing: schemas/self/v1/schemas/api/schemas/positions/response/%/editor.metapack
( 66%) Producing: schemas/self/v1/schemas/api/schemas/positions/rpc/request/%/blaze-exhaustive.metapack
...
( 67%) Producing: schemas/self/v1/schemas/api/schemas/search/rpc/request/%/blaze-exhaustive.metapack
...
( 68%) Producing: schemas/self/v1/schemas/api/schemas/stats/rpc/request/%/blaze-exhaustive.metapack
...
( 71%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/blaze-fast.metapack
( 71%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/editor.metapack
...
( 72%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/editor.metapack
...
( 75%) Producing: schemas/self/v1/schemas/mcp/resources/read/response/%/blaze-exhaustive.metapack
...
( 76%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/blaze-exhaustive.metapack
( 76%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/blaze-fast.metapack
...
( 77%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/blaze-fast.metapack
...
( 78%) Producing: schemas/self/v1/schemas/mcp/tools/list/request/%/blaze-fast.metapack
( 78%) Producing: schemas/self/v1/schemas/mcp/tools/list/request/%/editor.metapack
...
( 80%) Producing: explorer/self/v1/schemas/api/schemas/dependencies/rpc/request/%/schema-html.metapack
...
( 81%) Producing: explorer/self/v1/schemas/api/schemas/evaluate/rpc/%/directory.metapack
( 81%) Producing: explorer/self/v1/schemas/api/schemas/evaluate/rpc/request/%/schema-html.metapack
...
( 82%) Producing: explorer/self/v1/schemas/api/schemas/locations/rpc/request/%/schema-html.metapack
...
( 83%) Producing: explorer/self/v1/schemas/api/schemas/positions/rpc/%/directory.metapack
( 83%) Producing: explorer/self/v1/schemas/api/schemas/positions/rpc/request/%/schema-html.metapack
...
( 84%) Producing: explorer/self/v1/schemas/api/schemas/stats/rpc/%/directory.metapack
( 84%) Producing: explorer/self/v1/schemas/api/schemas/stats/rpc/request/%/schema-html.metapack
...
( 88%) Producing: explorer/self/v1/schemas/mcp/tools/call/%/directory.metapack
...
( 89%) Producing: explorer/self/v1/schemas/mcp/tools/list/response/%/schema-html.metapack
...
( 90%) Producing: explorer/self/v1/schemas/api/schemas/dependents/rpc/%/directory-html.metapack
...
( 91%) Producing: explorer/self/v1/schemas/api/schemas/locations/rpc/%/directory-html.metapack
...
( 92%) Producing: explorer/self/v1/schemas/api/schemas/stats/%/directory.metapack
...
( 93%) Producing: explorer/self/v1/schemas/mcp/ping/%/directory-html.metapack
...
( 94%) Producing: explorer/self/v1/schemas/mcp/tools/call/%/directory-html.metapack
...
(  2%) Combining: schemas/example/schemas/foo/%/dependents.metapack
