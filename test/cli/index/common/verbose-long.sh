...
( 39%) Producing: schemas/self/v1/schemas/api/list/rpc/%/health.metapack
...
( 46%) Producing: schemas/self/v1/schemas/mcp/initialize/request/%/bundle.metapack
...
( 60%) Producing: explorer/self/v1/schemas/mcp/tools/list/response/%/schema.metapack
...
( 71%) Producing: schemas/self/v1/schemas/api/schemas/trace/request/%/blaze-fast.metapack
...
( 72%) Producing: schemas/self/v1/schemas/api/schemas/trace/rpc/%/blaze-fast.metapack
...
( 73%) Producing: schemas/self/v1/schemas/mcp/initialize/request/%/blaze-fast.metapack
...
( 74%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/blaze-fast.metapack
...
( 76%) Producing: schemas/self/v1/schemas/mcp/request/%/editor.metapack
...
( 77%) Producing: schemas/self/v1/schemas/mcp/resources/list/response/%/editor.metapack
...
( 81%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/blaze-fast.metapack
...
( 23%) Combining: schemas/self/v1/schemas/api/schemas/evaluate/rpc/%/dependents.metapack
...
( 32%) Combining: schemas/self/v1/schemas/api/schemas/locations/rpc/%/dependents.metapack
( 34%) Combining: schemas/self/v1/schemas/api/schemas/metadata/response/%/dependents.metapack
( 36%) Combining: schemas/self/v1/schemas/api/schemas/metadata/rpc/%/dependents.metapack
...
( 43%) Combining: schemas/self/v1/schemas/api/schemas/positions/rpc/%/dependents.metapack
( 45%) Combining: schemas/self/v1/schemas/api/schemas/search/response/%/dependents.metapack
( 47%) Combining: schemas/self/v1/schemas/api/schemas/search/rpc/%/dependents.metapack
( 50%) Combining: schemas/self/v1/schemas/api/schemas/stats/response/%/dependents.metapack
( 52%) Combining: schemas/self/v1/schemas/api/schemas/stats/rpc/%/dependents.metapack
...
( 58%) Combining: schemas/self/v1/schemas/api/schemas/trace/rpc/%/dependents.metapack
