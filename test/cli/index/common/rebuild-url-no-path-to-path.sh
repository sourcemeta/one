...
(  7%) Producing: schemas/example/foo/%/dependencies.metapack
(  7%) Producing: schemas/example/foo/%/locations.metapack
...
( 35%) Producing: schemas/example/foo/%/bundle.metapack
( 36%) Producing: schemas/example/foo/%/health.metapack
...
( 50%) Producing: explorer/example/foo/%/schema.metapack
...
( 57%) Producing: schemas/example/foo/%/blaze-fast.metapack
( 57%) Producing: schemas/example/foo/%/editor.metapack
...
( 78%) Producing: explorer/example/foo/%/schema-html.metapack
...
( 88%) Producing: explorer/example/%/directory-html.metapack
( 88%) Producing: explorer/example/%/login-html.metapack
