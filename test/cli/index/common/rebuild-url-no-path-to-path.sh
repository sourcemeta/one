...
( 36%) Producing: schemas/example/foo/%/bundle.metapack
...
( 51%) Producing: explorer/example/foo/%/schema.metapack
...
( 58%) Producing: schemas/example/foo/%/blaze-exhaustive.metapack
( 58%) Producing: schemas/example/foo/%/blaze-fast.metapack
( 58%) Producing: schemas/example/foo/%/editor.metapack
...
( 80%) Producing: explorer/example/foo/%/schema-html.metapack
...
( 90%) Producing: explorer/example/%/directory-html.metapack
