...
( 38%) Producing: schemas/example/foo/%/health.metapack
...
( 60%) Producing: schemas/example/foo/%/blaze-exhaustive.metapack
( 60%) Producing: schemas/example/foo/%/blaze-fast.metapack
