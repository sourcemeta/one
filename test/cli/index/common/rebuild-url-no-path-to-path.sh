...
( 20%) Producing: schemas/self/v1/schemas/api/schemas/locations/response/%/positions.metapack
...
( 22%) Producing: schemas/self/v1/schemas/api/schemas/metadata/response/%/stats.metapack
...
( 23%) Producing: schemas/self/v1/schemas/api/schemas/position/%/positions.metapack
...
( 25%) Producing: schemas/self/v1/schemas/api/schemas/positions/response/%/stats.metapack
...
( 27%) Producing: schemas/self/v1/schemas/api/schemas/stats/response/%/dependencies.metapack
...
( 74%) Producing: schemas/self/v1/schemas/configuration/collection/%/editor.metapack
