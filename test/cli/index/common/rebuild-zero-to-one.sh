...
( 62%) Producing: schemas/self/v1/schemas/api/schemas/metadata/response/%/blaze-exhaustive.metapack
...
( 82%) Producing: schemas/self/v1/schemas/mcp/tools/list/response/%/blaze-fast.metapack
...
( 97%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/%/directory-html.metapack
