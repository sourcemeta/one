...
( 39%) Producing: schemas/self/v1/schemas/api/schemas/output-error/%/bundle.metapack
...
( 68%) Producing: schemas/self/v1/schemas/mcp/prm/response/%/blaze-exhaustive.metapack
