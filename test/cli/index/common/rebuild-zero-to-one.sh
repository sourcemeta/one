...
(  1%) Resolving: self/v1/schemas/api/auth/login/response.json
...
(  8%) Producing: schemas/self/v1/schemas/api/auth/login/response/%/stats.metapack
...
( 37%) Producing: schemas/self/v1/schemas/api/auth/login/response/%/health.metapack
...
( 43%) Producing: schemas/self/v1/schemas/mcp/prm/response/%/health.metapack
...
( 52%) Producing: explorer/public/self/v1/schemas/api/schemas/dependents/response/%/schema.metapack
...
( 54%) Producing: explorer/public/self/v1/schemas/mcp/initialize/response/%/schema.metapack
...
( 59%) Producing: schemas/self/v1/schemas/api/auth/login/response/%/blaze-exhaustive.metapack
...
( 81%) Producing: explorer/public/self/v1/schemas/api/auth/login/%/directory.metapack
...
( 82%) Producing: explorer/public/self/v1/schemas/api/schemas/dependents/response/%/schema-html.metapack
...
( 83%) Producing: explorer/public/self/v1/schemas/api/schemas/metadata/%/directory.metapack
( 83%) Producing: explorer/public/self/v1/schemas/api/schemas/metadata/response/%/schema-html.metapack
...
( 84%) Producing: explorer/public/self/v1/schemas/api/schemas/search/%/directory.metapack
...
( 85%) Producing: explorer/public/self/v1/schemas/mcp/initialize/request/%/schema-html.metapack
...
( 87%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/list/%/directory.metapack
...
( 90%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/schema-html.metapack
...
( 93%) Producing: explorer/public/self/v1/schemas/api/schemas/evaluate/%/directory-html.metapack
...
( 94%) Producing: explorer/public/self/v1/schemas/mcp/initialize/%/directory-html.metapack
...
( 96%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/%/directory-html.metapack
...
(  1%) Combining: explorer/public/self/v1/schemas/api/auth/login/response/%/dependents.metapack
...
( 44%) Producing: explorer/public/schemas/test/%/schema.metapack
...
( 66%) Producing: explorer/public/schemas/%/directory.metapack
( 72%) Producing: explorer/public/schemas/test/%/schema-html.metapack
( 77%) Producing: explorer/public/%/directory.metapack
( 83%) Producing: explorer/public/schemas/%/directory-html.metapack
( 88%) Producing: explorer/public/%/directory-html.metapack
( 94%) Producing: explorer/public/%/search.metapack
(100%) Producing: explorer/public/%/mcp.metapack
