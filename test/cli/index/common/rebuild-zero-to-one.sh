...
( 68%) Producing: schemas/self/v1/schemas/api/schemas/trace/response/%/editor.metapack
...
( 69%) Producing: schemas/self/v1/schemas/mcp/initialize/request/%/blaze-exhaustive.metapack
