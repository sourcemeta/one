...
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/output-error.json (#10)
...
(  4%) Resolving: self/v1/schemas/api/schemas/dependencies/response.json
(  6%) Resolving: self/v1/schemas/api/schemas/dependents/response.json
(  8%) Resolving: self/v1/schemas/api/schemas/evaluate/request.json
(  9%) Resolving: self/v1/schemas/api/schemas/evaluate/response.json
( 11%) Resolving: self/v1/schemas/api/schemas/health/response.json
( 12%) Resolving: self/v1/schemas/api/schemas/locations/response.json
( 14%) Resolving: self/v1/schemas/api/schemas/metadata/response.json
( 16%) Resolving: self/v1/schemas/api/schemas/output-error.json
( 17%) Resolving: self/v1/schemas/api/schemas/position.json
( 19%) Resolving: self/v1/schemas/api/schemas/positions/response.json
( 20%) Resolving: self/v1/schemas/api/schemas/rdf/request.json
...
(  0%) Producing: explorer/public/%/401.metapack
(  0%) Producing: explorer/public/%/404.metapack
...
(  1%) Producing: schemas/self/v1/schemas/api/schemas/output-error/%/schema.metapack
...
(  7%) Producing: schemas/self/v1/schemas/api/error/%/locations.metapack
...
(  8%) Producing: schemas/self/v1/schemas/api/schemas/dependencies/response/%/dependencies.metapack
(  8%) Producing: schemas/self/v1/schemas/api/schemas/dependencies/response/%/locations.metapack
(  8%) Producing: schemas/self/v1/schemas/api/schemas/dependencies/response/%/positions.metapack
...
(  9%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/request/%/dependencies.metapack
(  9%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/request/%/locations.metapack
(  9%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/request/%/positions.metapack
(  9%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/request/%/stats.metapack
...
( 10%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/response/%/stats.metapack
( 10%) Producing: schemas/self/v1/schemas/api/schemas/health/response/%/dependencies.metapack
( 10%) Producing: schemas/self/v1/schemas/api/schemas/health/response/%/locations.metapack
( 10%) Producing: schemas/self/v1/schemas/api/schemas/health/response/%/positions.metapack
( 10%) Producing: schemas/self/v1/schemas/api/schemas/health/response/%/stats.metapack
...
( 11%) Producing: schemas/self/v1/schemas/api/schemas/locations/response/%/stats.metapack
( 11%) Producing: schemas/self/v1/schemas/api/schemas/metadata/response/%/dependencies.metapack
( 11%) Producing: schemas/self/v1/schemas/api/schemas/metadata/response/%/locations.metapack
( 11%) Producing: schemas/self/v1/schemas/api/schemas/metadata/response/%/positions.metapack
( 11%) Producing: schemas/self/v1/schemas/api/schemas/metadata/response/%/stats.metapack
( 11%) Producing: schemas/self/v1/schemas/api/schemas/output-error/%/dependencies.metapack
( 12%) Producing: schemas/self/v1/schemas/api/schemas/output-error/%/locations.metapack
( 12%) Producing: schemas/self/v1/schemas/api/schemas/output-error/%/positions.metapack
( 12%) Producing: schemas/self/v1/schemas/api/schemas/output-error/%/stats.metapack
...
( 12%) Producing: schemas/self/v1/schemas/api/schemas/position/%/stats.metapack
( 12%) Producing: schemas/self/v1/schemas/api/schemas/positions/response/%/dependencies.metapack
( 12%) Producing: schemas/self/v1/schemas/api/schemas/positions/response/%/locations.metapack
...
( 13%) Producing: schemas/self/v1/schemas/api/schemas/rdf/request/%/dependencies.metapack
( 13%) Producing: schemas/self/v1/schemas/api/schemas/rdf/request/%/locations.metapack
( 13%) Producing: schemas/self/v1/schemas/api/schemas/rdf/request/%/positions.metapack
( 13%) Producing: schemas/self/v1/schemas/api/schemas/rdf/request/%/stats.metapack
( 13%) Producing: schemas/self/v1/schemas/api/schemas/rdf/response/%/dependencies.metapack
( 13%) Producing: schemas/self/v1/schemas/api/schemas/rdf/response/%/locations.metapack
( 13%) Producing: schemas/self/v1/schemas/api/schemas/rdf/response/%/positions.metapack
...
( 17%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/locations.metapack
...
( 21%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/request/%/dependencies.metapack
...
( 22%) Producing: schemas/self/v1/schemas/mcp/response/%/dependencies.metapack
( 22%) Producing: schemas/self/v1/schemas/mcp/response/%/locations.metapack
...
( 23%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/dependencies.metapack
( 23%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/locations.metapack
( 23%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/positions.metapack
...
( 24%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/stats.metapack
( 24%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/dependencies.metapack
( 24%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/locations.metapack
( 24%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/positions.metapack
( 24%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/stats.metapack
...
( 25%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/stats.metapack
( 25%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/dependencies.metapack
( 25%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/locations.metapack
( 25%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/positions.metapack
( 25%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/stats.metapack
( 25%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/dependencies.metapack
...
( 26%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/stats.metapack
( 26%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/dependencies.metapack
( 26%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/locations.metapack
( 26%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/positions.metapack
( 26%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/stats.metapack
( 26%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/dependencies.metapack
...
( 27%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/stats.metapack
( 27%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/dependencies.metapack
( 27%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/locations.metapack
( 27%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/positions.metapack
( 27%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/stats.metapack
( 27%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/dependencies.metapack
( 27%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/locations.metapack
( 28%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/positions.metapack
( 28%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/stats.metapack
( 28%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/dependencies.metapack
( 28%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/locations.metapack
( 28%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/positions.metapack
( 28%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/stats.metapack
( 28%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/dependencies.metapack
( 28%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/locations.metapack
( 28%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/positions.metapack
( 29%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/stats.metapack
( 29%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/dependencies.metapack
( 29%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/locations.metapack
( 29%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/positions.metapack
( 29%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/stats.metapack
( 29%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/dependencies.metapack
( 29%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/locations.metapack
( 29%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/positions.metapack
( 29%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/stats.metapack
( 30%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/dependencies.metapack
( 30%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/locations.metapack
( 30%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/positions.metapack
( 30%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/stats.metapack
( 30%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/dependencies.metapack
( 30%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/locations.metapack
( 30%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/positions.metapack
( 30%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/stats.metapack
( 30%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/dependencies.metapack
( 31%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/locations.metapack
( 31%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/positions.metapack
( 31%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/stats.metapack
...
( 31%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/request/%/positions.metapack
( 31%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/request/%/stats.metapack
( 31%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/response/%/dependencies.metapack
...
( 32%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/locations.metapack
( 32%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/positions.metapack
( 32%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/stats.metapack
( 32%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/dependencies.metapack
( 32%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/locations.metapack
...
( 33%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/request/%/locations.metapack
( 33%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/request/%/positions.metapack
( 33%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/request/%/stats.metapack
( 33%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/response/%/dependencies.metapack
( 33%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/response/%/locations.metapack
( 33%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/response/%/positions.metapack
...
( 34%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/locations.metapack
( 34%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/positions.metapack
( 34%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/stats.metapack
( 34%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/dependencies.metapack
( 34%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/locations.metapack
( 34%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/positions.metapack
( 34%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/stats.metapack
...
( 36%) Producing: schemas/self/v1/schemas/api/schemas/dependencies/response/%/bundle.metapack
( 36%) Producing: schemas/self/v1/schemas/api/schemas/dependencies/response/%/health.metapack
( 36%) Producing: schemas/self/v1/schemas/api/schemas/dependents/response/%/bundle.metapack
( 36%) Producing: schemas/self/v1/schemas/api/schemas/dependents/response/%/health.metapack
( 36%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/request/%/bundle.metapack
( 37%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/request/%/health.metapack
( 37%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/response/%/bundle.metapack
( 37%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/response/%/health.metapack
( 37%) Producing: schemas/self/v1/schemas/api/schemas/health/response/%/bundle.metapack
( 37%) Producing: schemas/self/v1/schemas/api/schemas/health/response/%/health.metapack
( 37%) Producing: schemas/self/v1/schemas/api/schemas/locations/response/%/bundle.metapack
( 37%) Producing: schemas/self/v1/schemas/api/schemas/locations/response/%/health.metapack
( 37%) Producing: schemas/self/v1/schemas/api/schemas/metadata/response/%/bundle.metapack
( 37%) Producing: schemas/self/v1/schemas/api/schemas/metadata/response/%/health.metapack
( 38%) Producing: schemas/self/v1/schemas/api/schemas/output-error/%/bundle.metapack
( 38%) Producing: schemas/self/v1/schemas/api/schemas/output-error/%/health.metapack
( 38%) Producing: schemas/self/v1/schemas/api/schemas/position/%/bundle.metapack
( 38%) Producing: schemas/self/v1/schemas/api/schemas/position/%/health.metapack
( 38%) Producing: schemas/self/v1/schemas/api/schemas/positions/response/%/bundle.metapack
( 38%) Producing: schemas/self/v1/schemas/api/schemas/positions/response/%/health.metapack
( 38%) Producing: schemas/self/v1/schemas/api/schemas/rdf/request/%/bundle.metapack
( 38%) Producing: schemas/self/v1/schemas/api/schemas/rdf/request/%/health.metapack
( 38%) Producing: schemas/self/v1/schemas/api/schemas/rdf/response/%/bundle.metapack
( 39%) Producing: schemas/self/v1/schemas/api/schemas/rdf/response/%/health.metapack
( 39%) Producing: schemas/self/v1/schemas/api/schemas/search/response/%/bundle.metapack
( 39%) Producing: schemas/self/v1/schemas/api/schemas/search/response/%/health.metapack
( 39%) Producing: schemas/self/v1/schemas/api/schemas/stats/response/%/bundle.metapack
( 39%) Producing: schemas/self/v1/schemas/api/schemas/stats/response/%/health.metapack
( 39%) Producing: schemas/self/v1/schemas/api/schemas/trace/request/%/bundle.metapack
( 39%) Producing: schemas/self/v1/schemas/api/schemas/trace/request/%/health.metapack
( 39%) Producing: schemas/self/v1/schemas/api/schemas/trace/response/%/bundle.metapack
( 39%) Producing: schemas/self/v1/schemas/api/schemas/trace/response/%/health.metapack
( 40%) Producing: schemas/self/v1/schemas/mcp/error/%/bundle.metapack
( 40%) Producing: schemas/self/v1/schemas/mcp/error/%/health.metapack
( 40%) Producing: schemas/self/v1/schemas/mcp/initialize/request/%/bundle.metapack
( 40%) Producing: schemas/self/v1/schemas/mcp/initialize/request/%/health.metapack
( 40%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/bundle.metapack
( 40%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/health.metapack
( 40%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/bundle.metapack
( 40%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/health.metapack
( 40%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/bundle.metapack
( 41%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/health.metapack
( 41%) Producing: schemas/self/v1/schemas/mcp/ping/request/%/bundle.metapack
...
( 42%) Producing: schemas/self/v1/schemas/mcp/resources/list/request/%/health.metapack
( 42%) Producing: schemas/self/v1/schemas/mcp/resources/list/response/%/bundle.metapack
( 42%) Producing: schemas/self/v1/schemas/mcp/resources/list/response/%/health.metapack
( 42%) Producing: schemas/self/v1/schemas/mcp/resources/read/request/%/bundle.metapack
( 42%) Producing: schemas/self/v1/schemas/mcp/resources/read/request/%/health.metapack
( 42%) Producing: schemas/self/v1/schemas/mcp/resources/read/response/%/bundle.metapack
( 42%) Producing: schemas/self/v1/schemas/mcp/resources/read/response/%/health.metapack
( 43%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/request/%/bundle.metapack
( 43%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/request/%/health.metapack
( 43%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/bundle.metapack
( 43%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/health.metapack
( 43%) Producing: schemas/self/v1/schemas/mcp/response/%/bundle.metapack
( 43%) Producing: schemas/self/v1/schemas/mcp/response/%/health.metapack
( 43%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/request/%/bundle.metapack
( 43%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/request/%/health.metapack
( 43%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/bundle.metapack
( 44%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/health.metapack
( 44%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/bundle.metapack
( 44%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/health.metapack
( 44%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/bundle.metapack
( 44%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/health.metapack
( 44%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/bundle.metapack
( 44%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/health.metapack
( 44%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/bundle.metapack
( 44%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/health.metapack
( 45%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/bundle.metapack
( 45%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/health.metapack
( 45%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/bundle.metapack
( 45%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/health.metapack
( 45%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/bundle.metapack
( 45%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/health.metapack
( 45%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/bundle.metapack
( 45%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/health.metapack
( 45%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/bundle.metapack
( 46%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/health.metapack
( 46%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/bundle.metapack
( 46%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/health.metapack
( 46%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/bundle.metapack
( 46%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/health.metapack
( 46%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/bundle.metapack
( 46%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/health.metapack
( 46%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/bundle.metapack
( 46%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/health.metapack
( 47%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/bundle.metapack
( 47%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/health.metapack
( 47%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/bundle.metapack
( 47%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/health.metapack
( 47%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/bundle.metapack
( 47%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/health.metapack
( 47%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/request/%/bundle.metapack
( 47%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/request/%/health.metapack
( 48%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/response/%/bundle.metapack
( 48%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/response/%/health.metapack
( 48%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/bundle.metapack
( 48%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/health.metapack
( 48%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/bundle.metapack
( 48%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/health.metapack
( 48%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/request/%/bundle.metapack
( 48%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/request/%/health.metapack
( 48%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/response/%/bundle.metapack
( 49%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/response/%/health.metapack
( 49%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/bundle.metapack
( 49%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/health.metapack
( 49%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/bundle.metapack
( 49%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/health.metapack
( 49%) Producing: schemas/self/v1/schemas/mcp/tools/list/request/%/bundle.metapack
( 49%) Producing: schemas/self/v1/schemas/mcp/tools/list/request/%/health.metapack
( 49%) Producing: schemas/self/v1/schemas/mcp/tools/list/response/%/bundle.metapack
( 49%) Producing: schemas/self/v1/schemas/mcp/tools/list/response/%/health.metapack
( 50%) Producing: explorer/public/self/v1/schemas/api/error/%/schema.metapack
( 50%) Producing: explorer/public/self/v1/schemas/api/list/response/%/schema.metapack
( 50%) Producing: explorer/public/self/v1/schemas/api/schemas/dependencies/response/%/schema.metapack
( 50%) Producing: explorer/public/self/v1/schemas/api/schemas/dependents/response/%/schema.metapack
( 50%) Producing: explorer/public/self/v1/schemas/api/schemas/evaluate/request/%/schema.metapack
( 50%) Producing: explorer/public/self/v1/schemas/api/schemas/evaluate/response/%/schema.metapack
( 50%) Producing: explorer/public/self/v1/schemas/api/schemas/health/response/%/schema.metapack
( 50%) Producing: explorer/public/self/v1/schemas/api/schemas/locations/response/%/schema.metapack
( 50%) Producing: explorer/public/self/v1/schemas/api/schemas/metadata/response/%/schema.metapack
( 51%) Producing: explorer/public/self/v1/schemas/api/schemas/output-error/%/schema.metapack
( 51%) Producing: explorer/public/self/v1/schemas/api/schemas/position/%/schema.metapack
( 51%) Producing: explorer/public/self/v1/schemas/api/schemas/positions/response/%/schema.metapack
( 51%) Producing: explorer/public/self/v1/schemas/api/schemas/rdf/request/%/schema.metapack
( 51%) Producing: explorer/public/self/v1/schemas/api/schemas/rdf/response/%/schema.metapack
( 51%) Producing: explorer/public/self/v1/schemas/api/schemas/search/response/%/schema.metapack
( 51%) Producing: explorer/public/self/v1/schemas/api/schemas/stats/response/%/schema.metapack
( 51%) Producing: explorer/public/self/v1/schemas/api/schemas/trace/request/%/schema.metapack
( 51%) Producing: explorer/public/self/v1/schemas/api/schemas/trace/response/%/schema.metapack
( 52%) Producing: explorer/public/self/v1/schemas/mcp/error/%/schema.metapack
( 52%) Producing: explorer/public/self/v1/schemas/mcp/initialize/request/%/schema.metapack
( 52%) Producing: explorer/public/self/v1/schemas/mcp/initialize/response/%/schema.metapack
( 52%) Producing: explorer/public/self/v1/schemas/mcp/notifications/cancelled/%/schema.metapack
( 52%) Producing: explorer/public/self/v1/schemas/mcp/notifications/initialized/%/schema.metapack
( 52%) Producing: explorer/public/self/v1/schemas/mcp/ping/request/%/schema.metapack
( 52%) Producing: explorer/public/self/v1/schemas/mcp/ping/response/%/schema.metapack
( 52%) Producing: explorer/public/self/v1/schemas/mcp/prm/response/%/schema.metapack
( 53%) Producing: explorer/public/self/v1/schemas/mcp/request/%/schema.metapack
( 53%) Producing: explorer/public/self/v1/schemas/mcp/resources/list/request/%/schema.metapack
( 53%) Producing: explorer/public/self/v1/schemas/mcp/resources/list/response/%/schema.metapack
( 53%) Producing: explorer/public/self/v1/schemas/mcp/resources/read/request/%/schema.metapack
( 53%) Producing: explorer/public/self/v1/schemas/mcp/resources/read/response/%/schema.metapack
( 53%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/list/request/%/schema.metapack
( 53%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/list/response/%/schema.metapack
( 53%) Producing: explorer/public/self/v1/schemas/mcp/response/%/schema.metapack
( 53%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/request/%/schema.metapack
( 54%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/schema.metapack
( 54%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/schema.metapack
( 54%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/schema.metapack
( 54%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/schema.metapack
( 54%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/schema.metapack
( 54%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/schema.metapack
( 54%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/schema.metapack
( 54%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/schema.metapack
( 54%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/schema.metapack
( 55%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/schema.metapack
( 55%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/schema.metapack
( 55%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/schema.metapack
( 55%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/schema.metapack
( 55%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/schema.metapack
( 55%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/schema.metapack
( 55%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/schema.metapack
( 55%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/schema.metapack
( 55%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/list-directory/request/%/schema.metapack
( 56%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/list-directory/response/%/schema.metapack
( 56%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/request/%/schema.metapack
( 56%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/response/%/schema.metapack
( 56%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/request/%/schema.metapack
( 56%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/response/%/schema.metapack
( 56%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/schema.metapack
( 56%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/schema.metapack
( 56%) Producing: explorer/public/self/v1/schemas/mcp/tools/list/request/%/schema.metapack
( 56%) Producing: explorer/public/self/v1/schemas/mcp/tools/list/response/%/schema.metapack
( 57%) Producing: schemas/self/v1/schemas/api/error/%/blaze-exhaustive.metapack
( 57%) Producing: schemas/self/v1/schemas/api/error/%/blaze-fast.metapack
...
( 57%) Producing: schemas/self/v1/schemas/api/schemas/dependencies/response/%/blaze-exhaustive.metapack
( 57%) Producing: schemas/self/v1/schemas/api/schemas/dependencies/response/%/blaze-fast.metapack
( 58%) Producing: schemas/self/v1/schemas/api/schemas/dependencies/response/%/editor.metapack
( 58%) Producing: schemas/self/v1/schemas/api/schemas/dependents/response/%/blaze-exhaustive.metapack
( 58%) Producing: schemas/self/v1/schemas/api/schemas/dependents/response/%/blaze-fast.metapack
( 58%) Producing: schemas/self/v1/schemas/api/schemas/dependents/response/%/editor.metapack
( 58%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/request/%/blaze-exhaustive.metapack
( 58%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/request/%/blaze-fast.metapack
( 58%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/request/%/editor.metapack
( 58%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/response/%/blaze-exhaustive.metapack
( 58%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/response/%/blaze-fast.metapack
( 59%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/response/%/editor.metapack
( 59%) Producing: schemas/self/v1/schemas/api/schemas/health/response/%/blaze-exhaustive.metapack
( 59%) Producing: schemas/self/v1/schemas/api/schemas/health/response/%/blaze-fast.metapack
( 59%) Producing: schemas/self/v1/schemas/api/schemas/health/response/%/editor.metapack
( 59%) Producing: schemas/self/v1/schemas/api/schemas/locations/response/%/blaze-exhaustive.metapack
( 59%) Producing: schemas/self/v1/schemas/api/schemas/locations/response/%/blaze-fast.metapack
( 59%) Producing: schemas/self/v1/schemas/api/schemas/locations/response/%/editor.metapack
( 59%) Producing: schemas/self/v1/schemas/api/schemas/metadata/response/%/blaze-exhaustive.metapack
( 59%) Producing: schemas/self/v1/schemas/api/schemas/metadata/response/%/blaze-fast.metapack
( 60%) Producing: schemas/self/v1/schemas/api/schemas/metadata/response/%/editor.metapack
( 60%) Producing: schemas/self/v1/schemas/api/schemas/output-error/%/blaze-exhaustive.metapack
( 60%) Producing: schemas/self/v1/schemas/api/schemas/output-error/%/blaze-fast.metapack
( 60%) Producing: schemas/self/v1/schemas/api/schemas/output-error/%/editor.metapack
( 60%) Producing: schemas/self/v1/schemas/api/schemas/position/%/blaze-exhaustive.metapack
( 60%) Producing: schemas/self/v1/schemas/api/schemas/position/%/blaze-fast.metapack
( 60%) Producing: schemas/self/v1/schemas/api/schemas/position/%/editor.metapack
( 60%) Producing: schemas/self/v1/schemas/api/schemas/positions/response/%/blaze-exhaustive.metapack
( 60%) Producing: schemas/self/v1/schemas/api/schemas/positions/response/%/blaze-fast.metapack
( 61%) Producing: schemas/self/v1/schemas/api/schemas/positions/response/%/editor.metapack
( 61%) Producing: schemas/self/v1/schemas/api/schemas/rdf/request/%/blaze-exhaustive.metapack
( 61%) Producing: schemas/self/v1/schemas/api/schemas/rdf/request/%/blaze-fast.metapack
( 61%) Producing: schemas/self/v1/schemas/api/schemas/rdf/request/%/editor.metapack
( 61%) Producing: schemas/self/v1/schemas/api/schemas/rdf/response/%/blaze-exhaustive.metapack
( 61%) Producing: schemas/self/v1/schemas/api/schemas/rdf/response/%/blaze-fast.metapack
( 61%) Producing: schemas/self/v1/schemas/api/schemas/rdf/response/%/editor.metapack
( 61%) Producing: schemas/self/v1/schemas/api/schemas/search/response/%/blaze-exhaustive.metapack
( 61%) Producing: schemas/self/v1/schemas/api/schemas/search/response/%/blaze-fast.metapack
( 62%) Producing: schemas/self/v1/schemas/api/schemas/search/response/%/editor.metapack
( 62%) Producing: schemas/self/v1/schemas/api/schemas/stats/response/%/blaze-exhaustive.metapack
( 62%) Producing: schemas/self/v1/schemas/api/schemas/stats/response/%/blaze-fast.metapack
( 62%) Producing: schemas/self/v1/schemas/api/schemas/stats/response/%/editor.metapack
( 62%) Producing: schemas/self/v1/schemas/api/schemas/trace/request/%/blaze-exhaustive.metapack
( 62%) Producing: schemas/self/v1/schemas/api/schemas/trace/request/%/blaze-fast.metapack
( 62%) Producing: schemas/self/v1/schemas/api/schemas/trace/request/%/editor.metapack
( 62%) Producing: schemas/self/v1/schemas/api/schemas/trace/response/%/blaze-exhaustive.metapack
( 62%) Producing: schemas/self/v1/schemas/api/schemas/trace/response/%/blaze-fast.metapack
( 63%) Producing: schemas/self/v1/schemas/api/schemas/trace/response/%/editor.metapack
( 63%) Producing: schemas/self/v1/schemas/mcp/error/%/blaze-exhaustive.metapack
( 63%) Producing: schemas/self/v1/schemas/mcp/error/%/blaze-fast.metapack
( 63%) Producing: schemas/self/v1/schemas/mcp/error/%/editor.metapack
( 63%) Producing: schemas/self/v1/schemas/mcp/initialize/request/%/blaze-exhaustive.metapack
( 63%) Producing: schemas/self/v1/schemas/mcp/initialize/request/%/blaze-fast.metapack
( 63%) Producing: schemas/self/v1/schemas/mcp/initialize/request/%/editor.metapack
( 63%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/blaze-exhaustive.metapack
( 64%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/blaze-fast.metapack
( 64%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/editor.metapack
( 64%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/blaze-exhaustive.metapack
( 64%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/blaze-fast.metapack
( 64%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/editor.metapack
( 64%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/blaze-exhaustive.metapack
( 64%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/blaze-fast.metapack
( 64%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/editor.metapack
( 64%) Producing: schemas/self/v1/schemas/mcp/ping/request/%/blaze-exhaustive.metapack
( 65%) Producing: schemas/self/v1/schemas/mcp/ping/request/%/blaze-fast.metapack
( 65%) Producing: schemas/self/v1/schemas/mcp/ping/request/%/editor.metapack
...
( 66%) Producing: schemas/self/v1/schemas/mcp/resources/list/request/%/blaze-exhaustive.metapack
( 66%) Producing: schemas/self/v1/schemas/mcp/resources/list/request/%/blaze-fast.metapack
( 66%) Producing: schemas/self/v1/schemas/mcp/resources/list/request/%/editor.metapack
( 66%) Producing: schemas/self/v1/schemas/mcp/resources/list/response/%/blaze-exhaustive.metapack
( 66%) Producing: schemas/self/v1/schemas/mcp/resources/list/response/%/blaze-fast.metapack
( 66%) Producing: schemas/self/v1/schemas/mcp/resources/list/response/%/editor.metapack
( 66%) Producing: schemas/self/v1/schemas/mcp/resources/read/request/%/blaze-exhaustive.metapack
( 67%) Producing: schemas/self/v1/schemas/mcp/resources/read/request/%/blaze-fast.metapack
( 67%) Producing: schemas/self/v1/schemas/mcp/resources/read/request/%/editor.metapack
( 67%) Producing: schemas/self/v1/schemas/mcp/resources/read/response/%/blaze-exhaustive.metapack
( 67%) Producing: schemas/self/v1/schemas/mcp/resources/read/response/%/blaze-fast.metapack
( 67%) Producing: schemas/self/v1/schemas/mcp/resources/read/response/%/editor.metapack
( 67%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/request/%/blaze-exhaustive.metapack
( 67%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/request/%/blaze-fast.metapack
( 67%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/request/%/editor.metapack
( 67%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/blaze-exhaustive.metapack
( 68%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/blaze-fast.metapack
( 68%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/editor.metapack
( 68%) Producing: schemas/self/v1/schemas/mcp/response/%/blaze-exhaustive.metapack
( 68%) Producing: schemas/self/v1/schemas/mcp/response/%/blaze-fast.metapack
( 68%) Producing: schemas/self/v1/schemas/mcp/response/%/editor.metapack
( 68%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/request/%/blaze-exhaustive.metapack
( 68%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/request/%/blaze-fast.metapack
( 68%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/request/%/editor.metapack
( 69%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/blaze-exhaustive.metapack
( 69%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/blaze-fast.metapack
( 69%) Producing: schemas/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/editor.metapack
( 69%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/blaze-exhaustive.metapack
( 69%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/blaze-fast.metapack
( 69%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/editor.metapack
( 69%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/blaze-exhaustive.metapack
( 69%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/blaze-fast.metapack
( 69%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/editor.metapack
( 70%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/blaze-exhaustive.metapack
( 70%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/blaze-fast.metapack
( 70%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/editor.metapack
( 70%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/blaze-exhaustive.metapack
( 70%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/blaze-fast.metapack
( 70%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/editor.metapack
( 70%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/blaze-exhaustive.metapack
( 70%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/blaze-fast.metapack
( 70%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/editor.metapack
( 71%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/blaze-exhaustive.metapack
( 71%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/blaze-fast.metapack
( 71%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/editor.metapack
( 71%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/blaze-exhaustive.metapack
( 71%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/blaze-fast.metapack
( 71%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/editor.metapack
( 71%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/blaze-exhaustive.metapack
( 71%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/blaze-fast.metapack
( 71%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/editor.metapack
( 72%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/blaze-exhaustive.metapack
( 72%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/blaze-fast.metapack
( 72%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/editor.metapack
( 72%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/blaze-exhaustive.metapack
( 72%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/blaze-fast.metapack
( 72%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/editor.metapack
( 72%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/blaze-exhaustive.metapack
( 72%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/blaze-fast.metapack
( 72%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/editor.metapack
( 73%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/blaze-exhaustive.metapack
( 73%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/blaze-fast.metapack
( 73%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/editor.metapack
( 73%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/blaze-exhaustive.metapack
( 73%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/blaze-fast.metapack
( 73%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/editor.metapack
( 73%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/blaze-exhaustive.metapack
( 73%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/blaze-fast.metapack
( 74%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/editor.metapack
( 74%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/blaze-exhaustive.metapack
( 74%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/blaze-fast.metapack
( 74%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/editor.metapack
( 74%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/blaze-exhaustive.metapack
( 74%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/blaze-fast.metapack
( 74%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/editor.metapack
( 74%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/request/%/blaze-exhaustive.metapack
( 74%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/request/%/blaze-fast.metapack
( 75%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/request/%/editor.metapack
( 75%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/response/%/blaze-exhaustive.metapack
( 75%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/response/%/blaze-fast.metapack
( 75%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/response/%/editor.metapack
( 75%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/blaze-exhaustive.metapack
( 75%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/blaze-fast.metapack
( 75%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/editor.metapack
( 75%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/blaze-exhaustive.metapack
( 75%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/blaze-fast.metapack
( 76%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/editor.metapack
( 76%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/request/%/blaze-exhaustive.metapack
( 76%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/request/%/blaze-fast.metapack
( 76%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/request/%/editor.metapack
( 76%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/response/%/blaze-exhaustive.metapack
( 76%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/response/%/blaze-fast.metapack
( 76%) Producing: schemas/self/v1/schemas/mcp/tools/call/search-schemas/response/%/editor.metapack
( 76%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/blaze-exhaustive.metapack
( 76%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/blaze-fast.metapack
( 77%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/editor.metapack
( 77%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/blaze-exhaustive.metapack
( 77%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/blaze-fast.metapack
( 77%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/editor.metapack
( 77%) Producing: schemas/self/v1/schemas/mcp/tools/list/request/%/blaze-exhaustive.metapack
( 77%) Producing: schemas/self/v1/schemas/mcp/tools/list/request/%/blaze-fast.metapack
( 77%) Producing: schemas/self/v1/schemas/mcp/tools/list/request/%/editor.metapack
( 77%) Producing: schemas/self/v1/schemas/mcp/tools/list/response/%/blaze-exhaustive.metapack
( 77%) Producing: schemas/self/v1/schemas/mcp/tools/list/response/%/blaze-fast.metapack
( 78%) Producing: schemas/self/v1/schemas/mcp/tools/list/response/%/editor.metapack
( 78%) Producing: explorer/public/self/v1/schemas/api/error/%/schema-html.metapack
( 78%) Producing: explorer/public/self/v1/schemas/api/list/%/directory.metapack
( 78%) Producing: explorer/public/self/v1/schemas/api/list/response/%/schema-html.metapack
( 78%) Producing: explorer/public/self/v1/schemas/api/schemas/dependencies/%/directory.metapack
( 78%) Producing: explorer/public/self/v1/schemas/api/schemas/dependencies/response/%/schema-html.metapack
( 78%) Producing: explorer/public/self/v1/schemas/api/schemas/dependents/%/directory.metapack
( 78%) Producing: explorer/public/self/v1/schemas/api/schemas/dependents/response/%/schema-html.metapack
( 79%) Producing: explorer/public/self/v1/schemas/api/schemas/evaluate/%/directory.metapack
( 79%) Producing: explorer/public/self/v1/schemas/api/schemas/evaluate/request/%/schema-html.metapack
( 79%) Producing: explorer/public/self/v1/schemas/api/schemas/evaluate/response/%/schema-html.metapack
( 79%) Producing: explorer/public/self/v1/schemas/api/schemas/health/%/directory.metapack
( 79%) Producing: explorer/public/self/v1/schemas/api/schemas/health/response/%/schema-html.metapack
( 79%) Producing: explorer/public/self/v1/schemas/api/schemas/locations/%/directory.metapack
( 79%) Producing: explorer/public/self/v1/schemas/api/schemas/locations/response/%/schema-html.metapack
( 79%) Producing: explorer/public/self/v1/schemas/api/schemas/metadata/%/directory.metapack
( 79%) Producing: explorer/public/self/v1/schemas/api/schemas/metadata/response/%/schema-html.metapack
( 80%) Producing: explorer/public/self/v1/schemas/api/schemas/output-error/%/schema-html.metapack
( 80%) Producing: explorer/public/self/v1/schemas/api/schemas/position/%/schema-html.metapack
( 80%) Producing: explorer/public/self/v1/schemas/api/schemas/positions/%/directory.metapack
( 80%) Producing: explorer/public/self/v1/schemas/api/schemas/positions/response/%/schema-html.metapack
( 80%) Producing: explorer/public/self/v1/schemas/api/schemas/rdf/%/directory.metapack
( 80%) Producing: explorer/public/self/v1/schemas/api/schemas/rdf/request/%/schema-html.metapack
( 80%) Producing: explorer/public/self/v1/schemas/api/schemas/rdf/response/%/schema-html.metapack
( 80%) Producing: explorer/public/self/v1/schemas/api/schemas/search/%/directory.metapack
( 80%) Producing: explorer/public/self/v1/schemas/api/schemas/search/response/%/schema-html.metapack
( 81%) Producing: explorer/public/self/v1/schemas/api/schemas/stats/%/directory.metapack
( 81%) Producing: explorer/public/self/v1/schemas/api/schemas/stats/response/%/schema-html.metapack
( 81%) Producing: explorer/public/self/v1/schemas/api/schemas/trace/%/directory.metapack
( 81%) Producing: explorer/public/self/v1/schemas/api/schemas/trace/request/%/schema-html.metapack
( 81%) Producing: explorer/public/self/v1/schemas/api/schemas/trace/response/%/schema-html.metapack
( 81%) Producing: explorer/public/self/v1/schemas/mcp/error/%/schema-html.metapack
( 81%) Producing: explorer/public/self/v1/schemas/mcp/initialize/%/directory.metapack
( 81%) Producing: explorer/public/self/v1/schemas/mcp/initialize/request/%/schema-html.metapack
( 81%) Producing: explorer/public/self/v1/schemas/mcp/initialize/response/%/schema-html.metapack
( 82%) Producing: explorer/public/self/v1/schemas/mcp/notifications/%/directory.metapack
( 82%) Producing: explorer/public/self/v1/schemas/mcp/notifications/cancelled/%/schema-html.metapack
( 82%) Producing: explorer/public/self/v1/schemas/mcp/notifications/initialized/%/schema-html.metapack
( 82%) Producing: explorer/public/self/v1/schemas/mcp/ping/%/directory.metapack
( 82%) Producing: explorer/public/self/v1/schemas/mcp/ping/request/%/schema-html.metapack
( 82%) Producing: explorer/public/self/v1/schemas/mcp/ping/response/%/schema-html.metapack
( 82%) Producing: explorer/public/self/v1/schemas/mcp/prm/%/directory.metapack
( 82%) Producing: explorer/public/self/v1/schemas/mcp/prm/response/%/schema-html.metapack
( 82%) Producing: explorer/public/self/v1/schemas/mcp/request/%/schema-html.metapack
( 83%) Producing: explorer/public/self/v1/schemas/mcp/resources/list/%/directory.metapack
( 83%) Producing: explorer/public/self/v1/schemas/mcp/resources/list/request/%/schema-html.metapack
( 83%) Producing: explorer/public/self/v1/schemas/mcp/resources/list/response/%/schema-html.metapack
( 83%) Producing: explorer/public/self/v1/schemas/mcp/resources/read/%/directory.metapack
( 83%) Producing: explorer/public/self/v1/schemas/mcp/resources/read/request/%/schema-html.metapack
( 83%) Producing: explorer/public/self/v1/schemas/mcp/resources/read/response/%/schema-html.metapack
( 83%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/list/%/directory.metapack
( 83%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/list/request/%/schema-html.metapack
( 83%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/list/response/%/schema-html.metapack
( 84%) Producing: explorer/public/self/v1/schemas/mcp/response/%/schema-html.metapack
( 84%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/%/directory.metapack
( 84%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/request/%/schema-html.metapack
( 84%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/schema-html.metapack
( 84%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/%/directory.metapack
( 84%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/schema-html.metapack
( 84%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/schema-html.metapack
( 84%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/%/directory.metapack
( 85%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/schema-html.metapack
( 85%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/schema-html.metapack
( 85%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/%/directory.metapack
( 85%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/schema-html.metapack
( 85%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/schema-html.metapack
( 85%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/%/directory.metapack
( 85%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/schema-html.metapack
( 85%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/schema-html.metapack
( 85%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/%/directory.metapack
( 86%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/schema-html.metapack
( 86%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/schema-html.metapack
( 86%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/%/directory.metapack
( 86%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/schema-html.metapack
( 86%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/schema-html.metapack
( 86%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/%/directory.metapack
( 86%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/schema-html.metapack
( 86%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/schema-html.metapack
( 86%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/%/directory.metapack
( 87%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/schema-html.metapack
( 87%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/schema-html.metapack
( 87%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/list-directory/%/directory.metapack
( 87%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/list-directory/request/%/schema-html.metapack
( 87%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/list-directory/response/%/schema-html.metapack
( 87%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/request/%/schema-html.metapack
( 87%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/response/%/schema-html.metapack
( 87%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/%/directory.metapack
( 87%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/request/%/schema-html.metapack
( 88%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/response/%/schema-html.metapack
( 88%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/%/directory.metapack
( 88%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/schema-html.metapack
( 88%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/schema-html.metapack
( 88%) Producing: explorer/public/self/v1/schemas/mcp/tools/list/%/directory.metapack
( 88%) Producing: explorer/public/self/v1/schemas/mcp/tools/list/request/%/schema-html.metapack
( 88%) Producing: explorer/public/self/v1/schemas/mcp/tools/list/response/%/schema-html.metapack
( 88%) Producing: explorer/public/self/v1/schemas/api/list/%/directory-html.metapack
( 88%) Producing: explorer/public/self/v1/schemas/api/list/%/login-html.metapack
( 89%) Producing: explorer/public/self/v1/schemas/api/schemas/%/directory.metapack
( 89%) Producing: explorer/public/self/v1/schemas/api/schemas/dependencies/%/directory-html.metapack
( 89%) Producing: explorer/public/self/v1/schemas/api/schemas/dependencies/%/login-html.metapack
( 89%) Producing: explorer/public/self/v1/schemas/api/schemas/dependents/%/directory-html.metapack
( 89%) Producing: explorer/public/self/v1/schemas/api/schemas/dependents/%/login-html.metapack
( 89%) Producing: explorer/public/self/v1/schemas/api/schemas/evaluate/%/directory-html.metapack
( 89%) Producing: explorer/public/self/v1/schemas/api/schemas/evaluate/%/login-html.metapack
( 89%) Producing: explorer/public/self/v1/schemas/api/schemas/health/%/directory-html.metapack
( 90%) Producing: explorer/public/self/v1/schemas/api/schemas/health/%/login-html.metapack
( 90%) Producing: explorer/public/self/v1/schemas/api/schemas/locations/%/directory-html.metapack
( 90%) Producing: explorer/public/self/v1/schemas/api/schemas/locations/%/login-html.metapack
( 90%) Producing: explorer/public/self/v1/schemas/api/schemas/metadata/%/directory-html.metapack
( 90%) Producing: explorer/public/self/v1/schemas/api/schemas/metadata/%/login-html.metapack
( 90%) Producing: explorer/public/self/v1/schemas/api/schemas/positions/%/directory-html.metapack
( 90%) Producing: explorer/public/self/v1/schemas/api/schemas/positions/%/login-html.metapack
( 90%) Producing: explorer/public/self/v1/schemas/api/schemas/rdf/%/directory-html.metapack
( 90%) Producing: explorer/public/self/v1/schemas/api/schemas/rdf/%/login-html.metapack
( 91%) Producing: explorer/public/self/v1/schemas/api/schemas/search/%/directory-html.metapack
( 91%) Producing: explorer/public/self/v1/schemas/api/schemas/search/%/login-html.metapack
( 91%) Producing: explorer/public/self/v1/schemas/api/schemas/stats/%/directory-html.metapack
( 91%) Producing: explorer/public/self/v1/schemas/api/schemas/stats/%/login-html.metapack
( 91%) Producing: explorer/public/self/v1/schemas/api/schemas/trace/%/directory-html.metapack
( 91%) Producing: explorer/public/self/v1/schemas/api/schemas/trace/%/login-html.metapack
( 91%) Producing: explorer/public/self/v1/schemas/mcp/initialize/%/directory-html.metapack
( 91%) Producing: explorer/public/self/v1/schemas/mcp/initialize/%/login-html.metapack
( 91%) Producing: explorer/public/self/v1/schemas/mcp/notifications/%/directory-html.metapack
( 92%) Producing: explorer/public/self/v1/schemas/mcp/notifications/%/login-html.metapack
( 92%) Producing: explorer/public/self/v1/schemas/mcp/ping/%/directory-html.metapack
( 92%) Producing: explorer/public/self/v1/schemas/mcp/ping/%/login-html.metapack
( 92%) Producing: explorer/public/self/v1/schemas/mcp/prm/%/directory-html.metapack
( 92%) Producing: explorer/public/self/v1/schemas/mcp/prm/%/login-html.metapack
( 92%) Producing: explorer/public/self/v1/schemas/mcp/resources/list/%/directory-html.metapack
( 92%) Producing: explorer/public/self/v1/schemas/mcp/resources/list/%/login-html.metapack
( 92%) Producing: explorer/public/self/v1/schemas/mcp/resources/read/%/directory-html.metapack
( 92%) Producing: explorer/public/self/v1/schemas/mcp/resources/read/%/login-html.metapack
( 93%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/%/directory.metapack
( 93%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/list/%/directory-html.metapack
( 93%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/list/%/login-html.metapack
( 93%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/%/directory.metapack
( 93%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/%/directory-html.metapack
( 93%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/%/login-html.metapack
( 93%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/%/directory-html.metapack
( 93%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/%/login-html.metapack
( 93%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/%/directory-html.metapack
( 94%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/%/login-html.metapack
( 94%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/%/directory-html.metapack
( 94%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/%/login-html.metapack
( 94%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/%/directory-html.metapack
( 94%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/%/login-html.metapack
( 94%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/%/directory-html.metapack
( 94%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/%/login-html.metapack
( 94%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/%/directory-html.metapack
( 95%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/%/login-html.metapack
( 95%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/%/directory-html.metapack
( 95%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/%/login-html.metapack
( 95%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/%/directory-html.metapack
( 95%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/%/login-html.metapack
( 95%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/list-directory/%/directory-html.metapack
( 95%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/list-directory/%/login-html.metapack
( 95%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/%/directory-html.metapack
( 95%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/%/login-html.metapack
( 96%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/%/directory-html.metapack
( 96%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/%/login-html.metapack
( 96%) Producing: explorer/public/self/v1/schemas/mcp/tools/list/%/directory-html.metapack
( 96%) Producing: explorer/public/self/v1/schemas/mcp/tools/list/%/login-html.metapack
( 96%) Producing: explorer/public/self/v1/schemas/api/%/directory.metapack
( 96%) Producing: explorer/public/self/v1/schemas/api/schemas/%/directory-html.metapack
( 96%) Producing: explorer/public/self/v1/schemas/api/schemas/%/login-html.metapack
( 96%) Producing: explorer/public/self/v1/schemas/mcp/resources/%/directory.metapack
( 96%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/%/directory-html.metapack
( 97%) Producing: explorer/public/self/v1/schemas/mcp/resources/templates/%/login-html.metapack
( 97%) Producing: explorer/public/self/v1/schemas/mcp/tools/%/directory.metapack
( 97%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/%/directory-html.metapack
( 97%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/%/login-html.metapack
( 97%) Producing: explorer/public/self/v1/schemas/api/%/directory-html.metapack
( 97%) Producing: explorer/public/self/v1/schemas/api/%/login-html.metapack
( 97%) Producing: explorer/public/self/v1/schemas/mcp/%/directory.metapack
( 97%) Producing: explorer/public/self/v1/schemas/mcp/resources/%/directory-html.metapack
( 97%) Producing: explorer/public/self/v1/schemas/mcp/resources/%/login-html.metapack
( 98%) Producing: explorer/public/self/v1/schemas/mcp/tools/%/directory-html.metapack
( 98%) Producing: explorer/public/self/v1/schemas/mcp/tools/%/login-html.metapack
( 98%) Producing: explorer/public/self/v1/schemas/%/directory.metapack
( 98%) Producing: explorer/public/self/v1/schemas/mcp/%/directory-html.metapack
( 98%) Producing: explorer/public/self/v1/schemas/mcp/%/login-html.metapack
( 98%) Producing: explorer/public/self/v1/%/directory.metapack
( 98%) Producing: explorer/public/self/v1/schemas/%/directory-html.metapack
( 98%) Producing: explorer/public/self/v1/schemas/%/login-html.metapack
( 98%) Producing: explorer/public/self/%/directory.metapack
( 99%) Producing: explorer/public/self/v1/%/directory-html.metapack
( 99%) Producing: explorer/public/self/v1/%/login-html.metapack
( 99%) Producing: explorer/public/%/directory.metapack
( 99%) Producing: explorer/public/self/%/directory-html.metapack
( 99%) Producing: explorer/public/self/%/login-html.metapack
( 99%) Producing: explorer/public/%/directory-html.metapack
( 99%) Producing: explorer/public/%/login-html.metapack
( 99%) Producing: explorer/public/%/search.metapack
(100%) Producing: explorer/public/%/mcp.metapack
(  1%) Combining: explorer/public/self/v1/schemas/api/error/%/dependents.metapack
(  3%) Combining: explorer/public/self/v1/schemas/api/list/response/%/dependents.metapack
(  4%) Combining: explorer/public/self/v1/schemas/api/schemas/dependencies/response/%/dependents.metapack
(  6%) Combining: explorer/public/self/v1/schemas/api/schemas/dependents/response/%/dependents.metapack
(  8%) Combining: explorer/public/self/v1/schemas/api/schemas/evaluate/request/%/dependents.metapack
(  9%) Combining: explorer/public/self/v1/schemas/api/schemas/evaluate/response/%/dependents.metapack
( 11%) Combining: explorer/public/self/v1/schemas/api/schemas/health/response/%/dependents.metapack
( 12%) Combining: explorer/public/self/v1/schemas/api/schemas/locations/response/%/dependents.metapack
( 14%) Combining: explorer/public/self/v1/schemas/api/schemas/metadata/response/%/dependents.metapack
( 16%) Combining: explorer/public/self/v1/schemas/api/schemas/output-error/%/dependents.metapack
( 17%) Combining: explorer/public/self/v1/schemas/api/schemas/position/%/dependents.metapack
( 19%) Combining: explorer/public/self/v1/schemas/api/schemas/positions/response/%/dependents.metapack
( 20%) Combining: explorer/public/self/v1/schemas/api/schemas/rdf/request/%/dependents.metapack
( 22%) Combining: explorer/public/self/v1/schemas/api/schemas/rdf/response/%/dependents.metapack
( 24%) Combining: explorer/public/self/v1/schemas/api/schemas/search/response/%/dependents.metapack
( 25%) Combining: explorer/public/self/v1/schemas/api/schemas/stats/response/%/dependents.metapack
( 27%) Combining: explorer/public/self/v1/schemas/api/schemas/trace/request/%/dependents.metapack
( 29%) Combining: explorer/public/self/v1/schemas/api/schemas/trace/response/%/dependents.metapack
( 30%) Combining: explorer/public/self/v1/schemas/mcp/error/%/dependents.metapack
( 32%) Combining: explorer/public/self/v1/schemas/mcp/initialize/request/%/dependents.metapack
( 33%) Combining: explorer/public/self/v1/schemas/mcp/initialize/response/%/dependents.metapack
( 35%) Combining: explorer/public/self/v1/schemas/mcp/notifications/cancelled/%/dependents.metapack
( 37%) Combining: explorer/public/self/v1/schemas/mcp/notifications/initialized/%/dependents.metapack
( 38%) Combining: explorer/public/self/v1/schemas/mcp/ping/request/%/dependents.metapack
( 40%) Combining: explorer/public/self/v1/schemas/mcp/ping/response/%/dependents.metapack
( 41%) Combining: explorer/public/self/v1/schemas/mcp/prm/response/%/dependents.metapack
( 43%) Combining: explorer/public/self/v1/schemas/mcp/request/%/dependents.metapack
( 45%) Combining: explorer/public/self/v1/schemas/mcp/resources/list/request/%/dependents.metapack
( 46%) Combining: explorer/public/self/v1/schemas/mcp/resources/list/response/%/dependents.metapack
( 48%) Combining: explorer/public/self/v1/schemas/mcp/resources/read/request/%/dependents.metapack
( 50%) Combining: explorer/public/self/v1/schemas/mcp/resources/read/response/%/dependents.metapack
( 51%) Combining: explorer/public/self/v1/schemas/mcp/resources/templates/list/request/%/dependents.metapack
( 53%) Combining: explorer/public/self/v1/schemas/mcp/resources/templates/list/response/%/dependents.metapack
( 54%) Combining: explorer/public/self/v1/schemas/mcp/response/%/dependents.metapack
( 56%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/request/%/dependents.metapack
( 58%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/dependents.metapack
( 59%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/dependents.metapack
( 61%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/dependents.metapack
( 62%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/dependents.metapack
( 64%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/dependents.metapack
( 66%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/dependents.metapack
( 67%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/dependents.metapack
( 69%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/dependents.metapack
( 70%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/dependents.metapack
( 72%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/dependents.metapack
( 74%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/dependents.metapack
( 75%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/dependents.metapack
( 77%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/dependents.metapack
( 79%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/dependents.metapack
( 80%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/dependents.metapack
( 82%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/dependents.metapack
( 83%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/dependents.metapack
( 85%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/list-directory/request/%/dependents.metapack
( 87%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/list-directory/response/%/dependents.metapack
( 88%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/request/%/dependents.metapack
( 90%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/response/%/dependents.metapack
( 91%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/request/%/dependents.metapack
( 93%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/response/%/dependents.metapack
( 95%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/dependents.metapack
( 96%) Combining: explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/dependents.metapack
( 98%) Combining: explorer/public/self/v1/schemas/mcp/tools/list/request/%/dependents.metapack
(100%) Combining: explorer/public/self/v1/schemas/mcp/tools/list/response/%/dependents.metapack
EOF
...
./explorer/public/self/v1/schemas/api/error/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/error/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/list/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/list/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/schemas/dependencies/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/dependencies/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/schemas/dependents/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/dependents/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/schemas/evaluate/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/evaluate/request/%/schema.metapack
./explorer/public/self/v1/schemas/api/schemas/evaluate/response
./explorer/public/self/v1/schemas/api/schemas/evaluate/response/%
./explorer/public/self/v1/schemas/api/schemas/evaluate/response/%/dependents.metapack
./explorer/public/self/v1/schemas/api/schemas/evaluate/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/evaluate/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/schemas/health/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/health/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/schemas/locations/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/locations/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/schemas/metadata/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/metadata/response/%/schema.metapack
./explorer/public/self/v1/schemas/api/schemas/output-error
./explorer/public/self/v1/schemas/api/schemas/output-error/%
./explorer/public/self/v1/schemas/api/schemas/output-error/%/dependents.metapack
./explorer/public/self/v1/schemas/api/schemas/output-error/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/output-error/%/schema.metapack
./explorer/public/self/v1/schemas/api/schemas/position
./explorer/public/self/v1/schemas/api/schemas/position/%
./explorer/public/self/v1/schemas/api/schemas/position/%/dependents.metapack
./explorer/public/self/v1/schemas/api/schemas/position/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/position/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/schemas/positions/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/positions/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/schemas/rdf/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/rdf/request/%/schema.metapack
./explorer/public/self/v1/schemas/api/schemas/rdf/response
./explorer/public/self/v1/schemas/api/schemas/rdf/response/%
./explorer/public/self/v1/schemas/api/schemas/rdf/response/%/dependents.metapack
./explorer/public/self/v1/schemas/api/schemas/rdf/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/rdf/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/schemas/search/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/search/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/schemas/stats/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/stats/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/api/schemas/trace/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/trace/request/%/schema.metapack
./explorer/public/self/v1/schemas/api/schemas/trace/response
./explorer/public/self/v1/schemas/api/schemas/trace/response/%
./explorer/public/self/v1/schemas/api/schemas/trace/response/%/dependents.metapack
./explorer/public/self/v1/schemas/api/schemas/trace/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/api/schemas/trace/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/error/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/error/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/initialize/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/initialize/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/initialize/response
./explorer/public/self/v1/schemas/mcp/initialize/response/%
./explorer/public/self/v1/schemas/mcp/initialize/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/initialize/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/initialize/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/notifications/cancelled/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/notifications/cancelled/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/notifications/initialized
./explorer/public/self/v1/schemas/mcp/notifications/initialized/%
./explorer/public/self/v1/schemas/mcp/notifications/initialized/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/notifications/initialized/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/notifications/initialized/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/ping/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/ping/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/ping/response
./explorer/public/self/v1/schemas/mcp/ping/response/%
./explorer/public/self/v1/schemas/mcp/ping/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/ping/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/ping/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/prm/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/prm/response/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/request
./explorer/public/self/v1/schemas/mcp/request/%
./explorer/public/self/v1/schemas/mcp/request/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/request/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/resources/list/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/resources/list/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/resources/list/response
./explorer/public/self/v1/schemas/mcp/resources/list/response/%
./explorer/public/self/v1/schemas/mcp/resources/list/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/resources/list/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/resources/list/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/resources/read/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/resources/read/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/resources/read/response
./explorer/public/self/v1/schemas/mcp/resources/read/response/%
./explorer/public/self/v1/schemas/mcp/resources/read/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/resources/read/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/resources/read/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/resources/templates/list/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/resources/templates/list/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/resources/templates/list/response
./explorer/public/self/v1/schemas/mcp/resources/templates/list/response/%
./explorer/public/self/v1/schemas/mcp/resources/templates/list/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/resources/templates/list/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/resources/templates/list/response/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/response
./explorer/public/self/v1/schemas/mcp/response/%
./explorer/public/self/v1/schemas/mcp/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/response
./explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/evaluate-schema/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/response
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependents/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/response
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/response
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-locations/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/response
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/response
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/response
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/get-schema-stats/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/response
./explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/instance-to-rdf/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/list-directory/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/list-directory/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/list-directory/response
./explorer/public/self/v1/schemas/mcp/tools/call/list-directory/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/list-directory/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/list-directory/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/list-directory/response/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/request
./explorer/public/self/v1/schemas/mcp/tools/call/request/%
./explorer/public/self/v1/schemas/mcp/tools/call/request/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/response
./explorer/public/self/v1/schemas/mcp/tools/call/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/response
./explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/search-schemas/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response
./explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%
./explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/schema.metapack
...
./explorer/public/self/v1/schemas/mcp/tools/list/request/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/list/request/%/schema.metapack
./explorer/public/self/v1/schemas/mcp/tools/list/response
./explorer/public/self/v1/schemas/mcp/tools/list/response/%
./explorer/public/self/v1/schemas/mcp/tools/list/response/%/dependents.metapack
./explorer/public/self/v1/schemas/mcp/tools/list/response/%/schema-html.metapack
./explorer/public/self/v1/schemas/mcp/tools/list/response/%/schema.metapack
./routes.bin
./schemas
./schemas/self
./schemas/self/v1
...
( 20%) Producing: schemas/schemas/test/%/positions.metapack
( 25%) Producing: schemas/schemas/test/%/stats.metapack
( 30%) Producing: schemas/schemas/test/%/bundle.metapack
( 35%) Producing: schemas/schemas/test/%/health.metapack
( 40%) Producing: explorer/public/schemas/test/%/schema.metapack
( 45%) Producing: schemas/schemas/test/%/blaze-exhaustive.metapack
( 50%) Producing: schemas/schemas/test/%/blaze-fast.metapack
( 55%) Producing: schemas/schemas/test/%/editor.metapack
( 60%) Producing: explorer/public/schemas/%/directory.metapack
( 65%) Producing: explorer/public/schemas/test/%/schema-html.metapack
( 70%) Producing: explorer/public/%/directory.metapack
( 75%) Producing: explorer/public/schemas/%/directory-html.metapack
( 80%) Producing: explorer/public/schemas/%/login-html.metapack
( 85%) Producing: explorer/public/%/directory-html.metapack
( 90%) Producing: explorer/public/%/login-html.metapack
( 95%) Producing: explorer/public/%/search.metapack
(100%) Producing: explorer/public/%/mcp.metapack
(100%) Combining: explorer/public/schemas/test/%/dependents.metapack
EOF
diff "$TMP/output.txt" "$TMP/expected.txt"
...
./explorer/public/schemas/test
./explorer/public/schemas/test/%
./explorer/public/schemas/test/%/dependents.metapack
./explorer/public/schemas/test/%/schema-html.metapack
./explorer/public/schemas/test/%/schema.metapack
./explorer/public/self
./explorer/public/self/%
./explorer/public/self/%/directory-html.metapack
./explorer/public/self/%/directory.metapack
