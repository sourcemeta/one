...
./explorer/example/schemas/b/%/schema-html.metapack.deps
./explorer/example/schemas/b/%/schema.metapack
./explorer/example/schemas/b/%/schema.metapack.deps
./explorer/example/schemas/c
./explorer/example/schemas/c/%
./explorer/example/schemas/c/%/schema-html.metapack
./explorer/example/schemas/c/%/schema-html.metapack.deps
./explorer/example/schemas/c/%/schema.metapack
./explorer/example/schemas/c/%/schema.metapack.deps
./routes.bin
./routes.bin.deps
./schemas
./schemas/example
...
./schemas/example/schemas/b/%/blaze-exhaustive.metapack.deps
./schemas/example/schemas/b/%/blaze-fast.metapack
./schemas/example/schemas/b/%/blaze-fast.metapack.deps
./schemas/example/schemas/b/%/bundle.metapack
./schemas/example/schemas/b/%/bundle.metapack.deps
./schemas/example/schemas/b/%/dependencies.metapack
./schemas/example/schemas/b/%/dependencies.metapack.deps
./schemas/example/schemas/b/%/dependents.metapack
./schemas/example/schemas/b/%/dependents.metapack.deps
./schemas/example/schemas/b/%/editor.metapack
./schemas/example/schemas/b/%/editor.metapack.deps
./schemas/example/schemas/b/%/health.metapack
./schemas/example/schemas/b/%/health.metapack.deps
./schemas/example/schemas/b/%/locations.metapack
./schemas/example/schemas/b/%/locations.metapack.deps
./schemas/example/schemas/b/%/positions.metapack
./schemas/example/schemas/b/%/positions.metapack.deps
./schemas/example/schemas/b/%/schema.metapack
./schemas/example/schemas/b/%/schema.metapack.deps
./schemas/example/schemas/b/%/stats.metapack
./schemas/example/schemas/b/%/stats.metapack.deps
./schemas/example/schemas/c
./schemas/example/schemas/c/%
./schemas/example/schemas/c/%/blaze-exhaustive.metapack
./schemas/example/schemas/c/%/blaze-exhaustive.metapack.deps
./schemas/example/schemas/c/%/blaze-fast.metapack
./schemas/example/schemas/c/%/blaze-fast.metapack.deps
./schemas/example/schemas/c/%/bundle.metapack
./schemas/example/schemas/c/%/bundle.metapack.deps
./schemas/example/schemas/c/%/dependencies.metapack
./schemas/example/schemas/c/%/dependencies.metapack.deps
./schemas/example/schemas/c/%/dependents.metapack
./schemas/example/schemas/c/%/dependents.metapack.deps
./schemas/example/schemas/c/%/editor.metapack
./schemas/example/schemas/c/%/editor.metapack.deps
./schemas/example/schemas/c/%/health.metapack
./schemas/example/schemas/c/%/health.metapack.deps
./schemas/example/schemas/c/%/locations.metapack
./schemas/example/schemas/c/%/locations.metapack.deps
./schemas/example/schemas/c/%/positions.metapack
./schemas/example/schemas/c/%/positions.metapack.deps
./schemas/example/schemas/c/%/schema.metapack
./schemas/example/schemas/c/%/schema.metapack.deps
./schemas/example/schemas/c/%/stats.metapack
./schemas/example/schemas/c/%/stats.metapack.deps
./version.json
EOF
