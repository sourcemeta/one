...
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/evaluate/rpc/request.json (#12)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/health/response.json (#13)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/health/rpc/request.json (#14)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/locations/response.json (#15)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/locations/rpc/request.json (#16)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/metadata/response.json (#17)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/metadata/rpc/request.json (#18)
...
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/positions/rpc/request.json (#21)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/search/response.json (#22)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/search/rpc/request.json (#23)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/stats/response.json (#24)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/stats/rpc/request.json (#25)
...
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/trace/rpc/request.json (#28)
...
(  2%) Resolving: example/custom-meta.json
(  4%) Resolving: example/test.json
(  6%) Resolving: self/v1/schemas/api/error.json
(  8%) Resolving: self/v1/schemas/api/list/response.json
( 10%) Resolving: self/v1/schemas/api/list/rpc/request.json
( 12%) Resolving: self/v1/schemas/api/schemas/dependencies/response.json
( 14%) Resolving: self/v1/schemas/api/schemas/dependencies/rpc/request.json
( 17%) Resolving: self/v1/schemas/api/schemas/dependents/response.json
( 19%) Resolving: self/v1/schemas/api/schemas/dependents/rpc/request.json
...
( 34%) Resolving: self/v1/schemas/api/schemas/locations/rpc/request.json
...
( 44%) Resolving: self/v1/schemas/api/schemas/positions/rpc/request.json
( 46%) Resolving: self/v1/schemas/api/schemas/search/response.json
( 48%) Resolving: self/v1/schemas/api/schemas/search/rpc/request.json
( 51%) Resolving: self/v1/schemas/api/schemas/stats/response.json
( 53%) Resolving: self/v1/schemas/api/schemas/stats/rpc/request.json
( 55%) Resolving: self/v1/schemas/api/schemas/trace/request.json
( 57%) Resolving: self/v1/schemas/api/schemas/trace/response.json
( 59%) Resolving: self/v1/schemas/api/schemas/trace/rpc/request.json
