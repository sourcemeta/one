...
cat << 'EOF' > "$TMP/meta/custom.json"
{
  ...
  "$id": "https://other.example.com/meta/custom",
  "$vocabulary": {
...
cat << EOF > "$TMP/one.json"
{
  ...
  "contents": {
    "meta": {
      "baseUri": "https://other.example.com/meta",
      "path": "./meta"
    },
    "example": {
      "path": "./schemas",
      "resolve": {
        "urn:example:custom-meta": "https://other.example.com/meta/custom"
      }
    }
  }
}
...
error: Could not resolve the metaschema of the schema
  at identifier https://other.example.com/meta/custom
