...
( 18%) Resolving: self/v1/schemas/api/schemas/evaluate/request.json
...
( 27%) Resolving: self/v1/schemas/api/schemas/health/rpc.json
...
( 38%) Resolving: self/v1/schemas/api/schemas/position.json
...
( 81%) Resolving: self/v1/schemas/mcp/resources/list/response.json
...
( 90%) Resolving: self/v1/schemas/mcp/resources/templates/list/response.json
...
( 52%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/health.metapack
...
( 78%) Producing: schemas/self/v1/schemas/mcp/resources/list/response/%/blaze-exhaustive.metapack
...
( 79%) Producing: schemas/self/v1/schemas/mcp/resources/read/response/%/blaze-exhaustive.metapack
( 79%) Producing: schemas/self/v1/schemas/mcp/resources/read/response/%/blaze-fast.metapack
...
( 80%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/blaze-exhaustive.metapack
( 80%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/blaze-fast.metapack
...
( 81%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/blaze-exhaustive.metapack
( 81%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/blaze-fast.metapack
...
( 82%) Producing: schemas/self/v1/schemas/mcp/tools/list/response/%/blaze-exhaustive.metapack
...
( 91%) Producing: explorer/self/v1/schemas/mcp/resources/read/%/directory.metapack
...
( 92%) Producing: explorer/self/v1/schemas/mcp/response/%/schema-html.metapack
...
(  6%) Combining: schemas/self/v1/schemas/api/list/rpc/%/dependents.metapack
(  9%) Combining: schemas/self/v1/schemas/api/schemas/dependencies/response/%/dependents.metapack
( 11%) Combining: schemas/self/v1/schemas/api/schemas/dependencies/rpc/%/dependents.metapack
( 13%) Combining: schemas/self/v1/schemas/api/schemas/dependents/response/%/dependents.metapack
( 15%) Combining: schemas/self/v1/schemas/api/schemas/dependents/rpc/%/dependents.metapack
( 18%) Combining: schemas/self/v1/schemas/api/schemas/evaluate/request/%/dependents.metapack
( 20%) Combining: schemas/self/v1/schemas/api/schemas/evaluate/response/%/dependents.metapack
( 22%) Combining: schemas/self/v1/schemas/api/schemas/evaluate/rpc/%/dependents.metapack
( 25%) Combining: schemas/self/v1/schemas/api/schemas/health/response/%/dependents.metapack
( 27%) Combining: schemas/self/v1/schemas/api/schemas/health/rpc/%/dependents.metapack
( 29%) Combining: schemas/self/v1/schemas/api/schemas/locations/response/%/dependents.metapack
( 31%) Combining: schemas/self/v1/schemas/api/schemas/locations/rpc/%/dependents.metapack
...
( 38%) Combining: schemas/self/v1/schemas/api/schemas/position/%/dependents.metapack
...
( 59%) Combining: schemas/self/v1/schemas/api/schemas/trace/rpc/%/dependents.metapack
( 61%) Combining: schemas/self/v1/schemas/mcp/error/%/dependents.metapack
...
( 70%) Combining: schemas/self/v1/schemas/mcp/notifications/initialized/%/dependents.metapack
( 72%) Combining: schemas/self/v1/schemas/mcp/ping/request/%/dependents.metapack
...
( 79%) Combining: schemas/self/v1/schemas/mcp/resources/list/request/%/dependents.metapack
( 81%) Combining: schemas/self/v1/schemas/mcp/resources/list/response/%/dependents.metapack
...
( 90%) Combining: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/dependents.metapack
