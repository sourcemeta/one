...
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/rdf/request.json (#12)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/api/schemas/rdf/response.json (#13)
...
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/mcp/tools/call/instance-to-rdf/request.json (#49)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/mcp/tools/call/instance-to-rdf/response.json (#50)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/mcp/tools/call/list-directory/request.json (#51)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/mcp/tools/call/list-directory/response.json (#52)
...
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/mcp/tools/call/search-schemas/request.json (#55)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/mcp/tools/call/search-schemas/response.json (#56)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request.json (#57)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response.json (#58)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/mcp/tools/list/request.json (#59)
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/mcp/tools/list/response.json (#60)
...
( 16%) Resolving: self/v1/schemas/api/schemas/position.json
...
( 21%) Resolving: self/v1/schemas/api/schemas/rdf/response.json
...
( 76%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-positions/response.json
...
( 63%) Producing: schemas/self/v1/schemas/api/schemas/positions/response/%/editor.metapack
...
( 16%) Combining: schemas/self/v1/schemas/api/schemas/position/%/dependents.metapack
( 18%) Combining: schemas/self/v1/schemas/api/schemas/positions/response/%/dependents.metapack
( 20%) Combining: schemas/self/v1/schemas/api/schemas/rdf/request/%/dependents.metapack
( 21%) Combining: schemas/self/v1/schemas/api/schemas/rdf/response/%/dependents.metapack
( 23%) Combining: schemas/self/v1/schemas/api/schemas/search/response/%/dependents.metapack
...
( 61%) Combining: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/dependents.metapack
...
( 66%) Combining: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/response/%/dependents.metapack
...
( 71%) Combining: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/dependents.metapack
...
( 76%) Combining: schemas/self/v1/schemas/mcp/tools/call/get-schema-positions/response/%/dependents.metapack
