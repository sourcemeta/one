...
(  4%) Producing: schemas/self/v1/schemas/mcp/prm/response/%/schema.metapack
...
(  5%) Producing: schemas/self/v1/schemas/mcp/response/%/schema.metapack
...
(  7%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/schema.metapack
...
( 34%) Producing: schemas/self/v1/schemas/mcp/tools/call/list-directory/response/%/stats.metapack
...
( 35%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/stats.metapack
...
( 36%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/dependencies.metapack
...
( 37%) Producing: schemas/self/v1/schemas/mcp/tools/list/request/%/dependencies.metapack
...
( 50%) Producing: schemas/self/v1/schemas/mcp/tools/call/instance-to-rdf/request/%/health.metapack
...
( 52%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response/%/bundle.metapack
...
( 55%) Producing: explorer/public/self/v1/schemas/mcp/initialize/request/%/schema.metapack
...
( 57%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/schema.metapack
...
( 59%) Producing: explorer/public/self/v1/schemas/mcp/tools/call/list-directory/response/%/schema.metapack
...
( 60%) Producing: explorer/public/self/v1/schemas/mcp/tools/list/response/%/schema.metapack
