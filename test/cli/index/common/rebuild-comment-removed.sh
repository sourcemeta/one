...
(  3%) Producing: schemas/self/v1/schemas/api/schemas/trace/request/%/schema.metapack
...
( 57%) Producing: explorer/self/v1/schemas/mcp/tools/call/get-schema-dependencies/request/%/schema.metapack
( 57%) Producing: explorer/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/schema.metapack
...
( 58%) Producing: explorer/self/v1/schemas/mcp/tools/call/get-schema-metadata/response/%/schema.metapack
...
( 59%) Producing: explorer/self/v1/schemas/mcp/tools/call/list-directory/response/%/schema.metapack
...
( 69%) Producing: schemas/self/v1/schemas/mcp/ping/response/%/blaze-fast.metapack
...
( 89%) Producing: explorer/self/v1/schemas/mcp/tools/call/get-schema-dependencies/response/%/schema-html.metapack
...
( 90%) Producing: explorer/self/v1/schemas/mcp/tools/call/get-schema-locations/request/%/schema-html.metapack
...
( 91%) Producing: explorer/self/v1/schemas/mcp/tools/call/get-schema-stats/%/directory.metapack
...
( 92%) Producing: explorer/self/v1/schemas/mcp/tools/call/list-directory/response/%/schema-html.metapack
...
( 93%) Producing: explorer/self/v1/schemas/mcp/tools/list/%/directory.metapack
...
( 96%) Producing: explorer/self/v1/schemas/mcp/tools/call/evaluate-schema/%/directory-html.metapack
