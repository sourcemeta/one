...
(  1%) Resolving: example/schemas/meta-a.json
(  3%) Resolving: example/schemas/meta-b.json
...
( 12%) Resolving: self/v1/schemas/api/schemas/evaluate/request.json
...
( 17%) Resolving: self/v1/schemas/api/schemas/locations/response.json
...
( 72%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-locations/response.json
( 74%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-metadata/request.json
...
( 79%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-positions/response.json
( 81%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-stats/request.json
