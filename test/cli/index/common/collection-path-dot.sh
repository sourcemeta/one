...
( 24%) Producing: schemas/self/v1/schemas/api/schemas/search/response/%/dependencies.metapack
( 25%) Producing: schemas/self/v1/schemas/api/schemas/search/response/%/locations.metapack
( 25%) Producing: schemas/self/v1/schemas/api/schemas/search/response/%/positions.metapack
...
( 26%) Producing: schemas/self/v1/schemas/api/schemas/stats/response/%/locations.metapack
...
( 28%) Producing: schemas/self/v1/schemas/api/schemas/trace/response/%/positions.metapack
...
( 77%) Producing: explorer/self/v1/schemas/api/error/%/schema-html.metapack
