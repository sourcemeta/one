...
( 34%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/request/%/dependencies.metapack
...
( 36%) Producing: schemas/self/v1/schemas/mcp/tools/call/request/%/dependencies.metapack
...
( 60%) Producing: explorer/self/v1/schemas/mcp/tools/list/request/%/schema.metapack
...
( 73%) Producing: schemas/self/v1/schemas/api/schemas/trace/rpc/%/blaze-exhaustive.metapack
