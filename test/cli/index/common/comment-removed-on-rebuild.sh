...
(  5%) Producing: schemas/self/v1/schemas/api/schemas/stats/rpc/%/schema.metapack
...
( 35%) Producing: schemas/self/v1/schemas/mcp/resources/read/request/%/positions.metapack
...
( 36%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/request/%/dependencies.metapack
...
( 37%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/locations.metapack
...
( 38%) Producing: schemas/self/v1/schemas/mcp/response/%/stats.metapack
...
( 49%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/health.metapack
...
( 52%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/request/%/bundle.metapack
...
( 60%) Producing: explorer/self/v1/schemas/mcp/resources/templates/list/request/%/schema.metapack
...
( 80%) Producing: schemas/self/v1/schemas/mcp/resources/list/response/%/editor.metapack
...
( 82%) Producing: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/blaze-fast.metapack
