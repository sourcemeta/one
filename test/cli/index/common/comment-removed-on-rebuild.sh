...
(  6%) Producing: schemas/self/v1/schemas/mcp/error/%/schema.metapack
...
(  7%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/schema.metapack
...
( 35%) Producing: schemas/self/v1/schemas/mcp/request/%/positions.metapack
