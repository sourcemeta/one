...
( 31%) Resolving: self/v1/schemas/api/schemas/health/response.json
( 36%) Resolving: self/v1/schemas/api/schemas/locations/response.json
...
( 73%) Resolving: self/v1/schemas/configuration/collection.json
( 78%) Resolving: self/v1/schemas/configuration/configuration.json
( 84%) Resolving: self/v1/schemas/configuration/contents.json
( 89%) Resolving: self/v1/schemas/configuration/extends.json
...
( 33%) Producing: schemas/self/v1/schemas/configuration/extends/%/positions.metapack
...
( 36%) Producing: schemas/self/v1/schemas/configuration/path/%/positions.metapack
...
( 49%) Producing: schemas/self/v1/schemas/configuration/extends/%/health.metapack
...
( 76%) Producing: schemas/self/v1/schemas/configuration/extends/%/blaze-fast.metapack
( 76%) Producing: schemas/self/v1/schemas/configuration/extends/%/editor.metapack
( 77%) Producing: schemas/self/v1/schemas/configuration/page/%/blaze-exhaustive.metapack
...
( 78%) Producing: schemas/self/v1/schemas/configuration/path/%/blaze-exhaustive.metapack
...
( 31%) Combining: schemas/self/v1/schemas/api/schemas/health/response/%/dependents.metapack
( 36%) Combining: schemas/self/v1/schemas/api/schemas/locations/response/%/dependents.metapack
...
( 63%) Combining: schemas/self/v1/schemas/api/schemas/stats/response/%/dependents.metapack
( 68%) Combining: schemas/self/v1/schemas/api/schemas/trace/response/%/dependents.metapack
( 73%) Combining: schemas/self/v1/schemas/configuration/collection/%/dependents.metapack
( 78%) Combining: schemas/self/v1/schemas/configuration/configuration/%/dependents.metapack
( 84%) Combining: schemas/self/v1/schemas/configuration/contents/%/dependents.metapack
( 89%) Combining: schemas/self/v1/schemas/configuration/extends/%/dependents.metapack
( 94%) Combining: schemas/self/v1/schemas/configuration/page/%/dependents.metapack
