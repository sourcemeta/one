...
( 38%) Producing: schemas/self/v1/schemas/mcp/tools/list/response/%/stats.metapack
...
( 52%) Producing: schemas/self/v1/schemas/mcp/tools/call/response/%/bundle.metapack
...
( 60%) Producing: explorer/self/v1/schemas/mcp/tools/call/response/%/schema.metapack
...
( 26%) Combining: schemas/self/v1/schemas/api/schemas/health/rpc/%/dependents.metapack
...
( 35%) Combining: schemas/self/v1/schemas/api/schemas/metadata/rpc/%/dependents.metapack
...
( 42%) Combining: schemas/self/v1/schemas/api/schemas/positions/rpc/%/dependents.metapack
( 44%) Combining: schemas/self/v1/schemas/api/schemas/search/response/%/dependents.metapack
( 46%) Combining: schemas/self/v1/schemas/api/schemas/search/rpc/%/dependents.metapack
( 48%) Combining: schemas/self/v1/schemas/api/schemas/stats/response/%/dependents.metapack
( 51%) Combining: schemas/self/v1/schemas/api/schemas/stats/rpc/%/dependents.metapack
...
( 57%) Combining: schemas/self/v1/schemas/api/schemas/trace/rpc/%/dependents.metapack
