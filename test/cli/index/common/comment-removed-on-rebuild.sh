...
( 11%) Resolving: self/v1/schemas/api/schemas/dependencies/rpc/request.json
...
( 22%) Resolving: self/v1/schemas/api/schemas/evaluate/rpc/request.json
...
( 48%) Producing: schemas/self/v1/schemas/mcp/resources/list/response/%/bundle.metapack
...
( 58%) Producing: explorer/self/v1/schemas/mcp/tools/list/request/%/schema.metapack
...
( 62%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/rpc/request/%/editor.metapack
...
( 63%) Producing: schemas/self/v1/schemas/api/schemas/health/rpc/request/%/editor.metapack
...
( 96%) Producing: explorer/self/v1/schemas/api/schemas/trace/%/directory-html.metapack
...
(  6%) Combining: schemas/self/v1/schemas/api/list/rpc/request/%/dependents.metapack
(  8%) Combining: schemas/self/v1/schemas/api/schemas/dependencies/response/%/dependents.metapack
( 11%) Combining: schemas/self/v1/schemas/api/schemas/dependencies/rpc/request/%/dependents.metapack
( 13%) Combining: schemas/self/v1/schemas/api/schemas/dependents/response/%/dependents.metapack
( 15%) Combining: schemas/self/v1/schemas/api/schemas/dependents/rpc/request/%/dependents.metapack
( 17%) Combining: schemas/self/v1/schemas/api/schemas/evaluate/request/%/dependents.metapack
( 20%) Combining: schemas/self/v1/schemas/api/schemas/evaluate/response/%/dependents.metapack
( 22%) Combining: schemas/self/v1/schemas/api/schemas/evaluate/rpc/request/%/dependents.metapack
( 24%) Combining: schemas/self/v1/schemas/api/schemas/health/response/%/dependents.metapack
( 26%) Combining: schemas/self/v1/schemas/api/schemas/health/rpc/request/%/dependents.metapack
( 28%) Combining: schemas/self/v1/schemas/api/schemas/locations/response/%/dependents.metapack
( 31%) Combining: schemas/self/v1/schemas/api/schemas/locations/rpc/request/%/dependents.metapack
( 33%) Combining: schemas/self/v1/schemas/api/schemas/metadata/response/%/dependents.metapack
( 35%) Combining: schemas/self/v1/schemas/api/schemas/metadata/rpc/request/%/dependents.metapack
( 37%) Combining: schemas/self/v1/schemas/api/schemas/position/%/dependents.metapack
( 40%) Combining: schemas/self/v1/schemas/api/schemas/positions/response/%/dependents.metapack
( 42%) Combining: schemas/self/v1/schemas/api/schemas/positions/rpc/request/%/dependents.metapack
( 44%) Combining: schemas/self/v1/schemas/api/schemas/search/response/%/dependents.metapack
( 46%) Combining: schemas/self/v1/schemas/api/schemas/search/rpc/request/%/dependents.metapack
( 48%) Combining: schemas/self/v1/schemas/api/schemas/stats/response/%/dependents.metapack
( 51%) Combining: schemas/self/v1/schemas/api/schemas/stats/rpc/request/%/dependents.metapack
( 53%) Combining: schemas/self/v1/schemas/api/schemas/trace/request/%/dependents.metapack
( 55%) Combining: schemas/self/v1/schemas/api/schemas/trace/response/%/dependents.metapack
( 57%) Combining: schemas/self/v1/schemas/api/schemas/trace/rpc/request/%/dependents.metapack
( 60%) Combining: schemas/self/v1/schemas/mcp/error/%/dependents.metapack
( 62%) Combining: schemas/self/v1/schemas/mcp/initialize/request/%/dependents.metapack
( 64%) Combining: schemas/self/v1/schemas/mcp/initialize/response/%/dependents.metapack
( 66%) Combining: schemas/self/v1/schemas/mcp/notifications/cancelled/%/dependents.metapack
( 68%) Combining: schemas/self/v1/schemas/mcp/notifications/initialized/%/dependents.metapack
...
( 77%) Combining: schemas/self/v1/schemas/mcp/resources/list/request/%/dependents.metapack
...
( 88%) Combining: schemas/self/v1/schemas/mcp/resources/templates/list/response/%/dependents.metapack
