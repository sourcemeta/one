...
(  9%) Producing: schemas/example/schemas/test/%/stats.metapack
...
( 57%) Producing: schemas/example/schemas/test/%/blaze-exhaustive.metapack
( 57%) Producing: schemas/example/schemas/test/%/blaze-fast.metapack
