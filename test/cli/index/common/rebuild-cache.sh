...
(  3%) Resolving: example/schemas/foo.json
...
( 51%) Producing: explorer/example/schemas/foo/%/schema.metapack
...
(  3%) Combining: schemas/example/schemas/foo/%/dependents.metapack
