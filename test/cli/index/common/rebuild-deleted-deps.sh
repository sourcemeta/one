...
(  9%) Producing: schemas/example/schemas/a/%/stats.metapack
...
( 53%) Producing: explorer/self/v1/schemas/api/schemas/trace/response/%/schema.metapack
...
( 57%) Producing: schemas/example/schemas/a/%/blaze-exhaustive.metapack
...
( 67%) Producing: schemas/self/v1/schemas/mcp/error/%/blaze-exhaustive.metapack
...
( 68%) Producing: schemas/self/v1/schemas/mcp/initialize/request/%/blaze-fast.metapack
...
( 69%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/editor.metapack
...
( 70%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/blaze-exhaustive.metapack
...
( 71%) Producing: schemas/self/v1/schemas/mcp/ping/request/%/blaze-fast.metapack
...
( 72%) Producing: schemas/self/v1/schemas/mcp/ping/response/%/editor.metapack
( 72%) Producing: schemas/self/v1/schemas/mcp/request/%/blaze-exhaustive.metapack
...
( 73%) Producing: schemas/self/v1/schemas/mcp/resources/list/request/%/blaze-exhaustive.metapack
( 73%) Producing: schemas/self/v1/schemas/mcp/resources/list/request/%/blaze-fast.metapack
...
( 74%) Producing: schemas/self/v1/schemas/mcp/resources/list/response/%/blaze-fast.metapack
( 74%) Producing: schemas/self/v1/schemas/mcp/resources/list/response/%/editor.metapack
...
( 83%) Producing: explorer/self/v1/schemas/api/schemas/search/%/directory.metapack
( 83%) Producing: explorer/self/v1/schemas/api/schemas/search/response/%/schema-html.metapack
...
( 84%) Producing: explorer/self/v1/schemas/api/schemas/trace/%/directory.metapack
( 84%) Producing: explorer/self/v1/schemas/api/schemas/trace/response/%/schema-html.metapack
...
( 89%) Producing: explorer/self/v1/schemas/mcp/resources/templates/list/request/%/schema-html.metapack
( 89%) Producing: explorer/self/v1/schemas/mcp/resources/templates/list/response/%/schema-html.metapack
...
( 17%) Combining: schemas/self/v1/schemas/api/schemas/dependents/response/%/dependents.metapack
...
( 27%) Combining: schemas/self/v1/schemas/api/schemas/locations/response/%/dependents.metapack
( 31%) Combining: schemas/self/v1/schemas/api/schemas/metadata/response/%/dependents.metapack
( 34%) Combining: schemas/self/v1/schemas/api/schemas/position/%/dependents.metapack
( 37%) Combining: schemas/self/v1/schemas/api/schemas/positions/response/%/dependents.metapack
( 41%) Combining: schemas/self/v1/schemas/api/schemas/search/response/%/dependents.metapack
( 44%) Combining: schemas/self/v1/schemas/api/schemas/stats/response/%/dependents.metapack
( 48%) Combining: schemas/self/v1/schemas/api/schemas/trace/response/%/dependents.metapack
( 51%) Combining: schemas/self/v1/schemas/mcp/error/%/dependents.metapack
( 55%) Combining: schemas/self/v1/schemas/mcp/initialize/request/%/dependents.metapack
( 58%) Combining: schemas/self/v1/schemas/mcp/initialize/response/%/dependents.metapack
( 62%) Combining: schemas/self/v1/schemas/mcp/notifications/cancelled/%/dependents.metapack
( 65%) Combining: schemas/self/v1/schemas/mcp/notifications/initialized/%/dependents.metapack
( 68%) Combining: schemas/self/v1/schemas/mcp/ping/request/%/dependents.metapack
( 72%) Combining: schemas/self/v1/schemas/mcp/ping/response/%/dependents.metapack
