...
( 32%) Producing: schemas/self/v1/schemas/mcp/ping/response/%/dependencies.metapack
...
( 33%) Producing: schemas/self/v1/schemas/mcp/request/%/dependencies.metapack
...
( 34%) Producing: schemas/self/v1/schemas/mcp/request/%/stats.metapack
...
( 70%) Producing: schemas/self/v1/schemas/mcp/error/%/editor.metapack
...
( 73%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/editor.metapack
...
( 74%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/editor.metapack
( 74%) Producing: schemas/self/v1/schemas/mcp/ping/request/%/blaze-exhaustive.metapack
...
( 75%) Producing: schemas/self/v1/schemas/mcp/ping/response/%/blaze-exhaustive.metapack
...
( 88%) Producing: explorer/self/v1/schemas/mcp/ping/%/directory.metapack
...
(  4%) Combining: schemas/example/schemas/a/%/dependents.metapack
(  8%) Combining: schemas/self/v1/schemas/api/error/%/dependents.metapack
( 13%) Combining: schemas/self/v1/schemas/api/list/response/%/dependents.metapack
( 17%) Combining: schemas/self/v1/schemas/api/schemas/dependencies/response/%/dependents.metapack
( 21%) Combining: schemas/self/v1/schemas/api/schemas/dependents/response/%/dependents.metapack
( 26%) Combining: schemas/self/v1/schemas/api/schemas/evaluate/response/%/dependents.metapack
( 30%) Combining: schemas/self/v1/schemas/api/schemas/health/response/%/dependents.metapack
( 34%) Combining: schemas/self/v1/schemas/api/schemas/locations/response/%/dependents.metapack
( 39%) Combining: schemas/self/v1/schemas/api/schemas/metadata/response/%/dependents.metapack
( 43%) Combining: schemas/self/v1/schemas/api/schemas/position/%/dependents.metapack
( 47%) Combining: schemas/self/v1/schemas/api/schemas/positions/response/%/dependents.metapack
( 52%) Combining: schemas/self/v1/schemas/api/schemas/search/response/%/dependents.metapack
...
( 73%) Combining: schemas/self/v1/schemas/mcp/initialize/response/%/dependents.metapack
( 78%) Combining: schemas/self/v1/schemas/mcp/notifications/cancelled/%/dependents.metapack
( 82%) Combining: schemas/self/v1/schemas/mcp/notifications/initialized/%/dependents.metapack
