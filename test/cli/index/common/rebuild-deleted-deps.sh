...
(  1%) Producing: schemas/example/schemas/a/%/schema.metapack
...
( 51%) Producing: explorer/example/schemas/a/%/schema.metapack
...
(  3%) Combining: schemas/example/schemas/a/%/dependents.metapack
