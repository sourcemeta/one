...
(  7%) Resolving: example/schemas/a.json
...
(  9%) Producing: schemas/example/schemas/a/%/locations.metapack
...
( 54%) Producing: schemas/example/schemas/a/%/blaze-exhaustive.metapack
( 55%) Producing: schemas/example/schemas/a/%/blaze-fast.metapack
( 55%) Producing: schemas/example/schemas/a/%/editor.metapack
...
( 75%) Producing: explorer/example/schemas/a/%/schema-html.metapack
...
(  7%) Combining: schemas/example/schemas/a/%/dependents.metapack
