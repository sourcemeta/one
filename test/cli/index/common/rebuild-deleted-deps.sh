...
( 36%) Producing: schemas/example/schemas/a/%/bundle.metapack
( 36%) Producing: schemas/example/schemas/a/%/health.metapack
...
( 50%) Producing: explorer/example/schemas/a/%/schema.metapack
...
( 58%) Producing: schemas/example/schemas/a/%/blaze-exhaustive.metapack
( 58%) Producing: schemas/example/schemas/a/%/blaze-fast.metapack
( 58%) Producing: schemas/example/schemas/a/%/editor.metapack
...
( 79%) Producing: explorer/example/schemas/a/%/schema-html.metapack
...
(  2%) Combining: schemas/example/schemas/a/%/dependents.metapack
