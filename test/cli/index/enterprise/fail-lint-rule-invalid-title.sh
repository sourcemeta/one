...
( 15%) Producing: schemas/self/v1/schemas/api/schemas/health/rpc/%/stats.metapack
...
( 16%) Producing: schemas/self/v1/schemas/api/schemas/locations/rpc/%/positions.metapack
...
( 17%) Producing: schemas/self/v1/schemas/api/schemas/metadata/rpc/%/dependencies.metapack
...
( 19%) Producing: schemas/self/v1/schemas/api/schemas/positions/rpc/%/dependencies.metapack
...
( 22%) Producing: schemas/self/v1/schemas/api/schemas/stats/rpc/%/positions.metapack
( 22%) Producing: schemas/self/v1/schemas/api/schemas/stats/rpc/%/stats.metapack
...
( 24%) Producing: schemas/self/v1/schemas/api/schemas/trace/rpc/%/positions.metapack
( 24%) Producing: schemas/self/v1/schemas/api/schemas/trace/rpc/%/stats.metapack
...
( 39%) Producing: schemas/self/v1/schemas/api/schemas/dependents/rpc/%/bundle.metapack
...
( 40%) Producing: schemas/self/v1/schemas/api/schemas/evaluate/rpc/%/bundle.metapack
...
( 42%) Producing: schemas/self/v1/schemas/api/schemas/metadata/rpc/%/bundle.metapack
...
( 43%) Producing: schemas/self/v1/schemas/api/schemas/positions/rpc/%/bundle.metapack
...
( 48%) Producing: schemas/self/v1/schemas/mcp/request/%/health.metapack
