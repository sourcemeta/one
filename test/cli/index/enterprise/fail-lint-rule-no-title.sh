...
( 22%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/dependencies.metapack
...
( 23%) Producing: schemas/self/v1/schemas/mcp/notifications/cancelled/%/dependencies.metapack
...
( 24%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/dependencies.metapack
...
( 44%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/bundle.metapack
...
( 45%) Producing: schemas/self/v1/schemas/mcp/ping/response/%/bundle.metapack
...
( 46%) Producing: schemas/self/v1/schemas/mcp/resources/list/request/%/bundle.metapack
