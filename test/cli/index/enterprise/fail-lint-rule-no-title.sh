...
Detecting: $ONE_PREFIX/share/sourcemeta/one/self/v1/schemas/meta.json (#57)
Detecting: $(realpath "$TMP")/schemas/test.json (#58)
...
( 18%) Resolving: self/v1/schemas/api/schemas/positions/response.json
( 20%) Resolving: self/v1/schemas/api/schemas/search/response.json
( 22%) Resolving: self/v1/schemas/api/schemas/stats/response.json
( 24%) Resolving: self/v1/schemas/api/schemas/trace/request.json
( 25%) Resolving: self/v1/schemas/api/schemas/trace/response.json
( 27%) Resolving: self/v1/schemas/mcp/error.json
( 29%) Resolving: self/v1/schemas/mcp/initialize/request.json
( 31%) Resolving: self/v1/schemas/mcp/initialize/response.json
( 32%) Resolving: self/v1/schemas/mcp/notifications/cancelled.json
( 34%) Resolving: self/v1/schemas/mcp/notifications/initialized.json
( 36%) Resolving: self/v1/schemas/mcp/ping/request.json
( 37%) Resolving: self/v1/schemas/mcp/ping/response.json
( 39%) Resolving: self/v1/schemas/mcp/request.json
( 41%) Resolving: self/v1/schemas/mcp/resources/list/request.json
( 43%) Resolving: self/v1/schemas/mcp/resources/list/response.json
( 44%) Resolving: self/v1/schemas/mcp/resources/read/request.json
( 46%) Resolving: self/v1/schemas/mcp/resources/read/response.json
( 48%) Resolving: self/v1/schemas/mcp/resources/templates/list/request.json
( 50%) Resolving: self/v1/schemas/mcp/resources/templates/list/response.json
( 51%) Resolving: self/v1/schemas/mcp/response.json
( 53%) Resolving: self/v1/schemas/mcp/tools/call/evaluate-schema/request.json
( 55%) Resolving: self/v1/schemas/mcp/tools/call/evaluate-schema/response.json
( 56%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-dependencies/request.json
( 58%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-dependencies/response.json
( 60%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-dependents/request.json
( 62%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-dependents/response.json
( 63%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-health/request.json
( 65%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-health/response.json
( 67%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-locations/request.json
( 68%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-locations/response.json
( 70%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-metadata/request.json
( 72%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-metadata/response.json
( 74%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-positions/request.json
( 75%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-positions/response.json
( 77%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-stats/request.json
( 79%) Resolving: self/v1/schemas/mcp/tools/call/get-schema-stats/response.json
( 81%) Resolving: self/v1/schemas/mcp/tools/call/list-directory/request.json
( 82%) Resolving: self/v1/schemas/mcp/tools/call/list-directory/response.json
( 84%) Resolving: self/v1/schemas/mcp/tools/call/request.json
( 86%) Resolving: self/v1/schemas/mcp/tools/call/response.json
( 87%) Resolving: self/v1/schemas/mcp/tools/call/search-schemas/request.json
( 89%) Resolving: self/v1/schemas/mcp/tools/call/search-schemas/response.json
( 91%) Resolving: self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request.json
( 93%) Resolving: self/v1/schemas/mcp/tools/call/trace-schema-evaluation/response.json
( 94%) Resolving: self/v1/schemas/mcp/tools/list/request.json
( 96%) Resolving: self/v1/schemas/mcp/tools/list/response.json
( 98%) Resolving: self/v1/schemas/meta.json
...
(  3%) Producing: schemas/self/v1/schemas/mcp/resources/read/response/%/schema.metapack
...
(  4%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-dependents/request/%/schema.metapack
...
( 14%) Producing: schemas/self/v1/schemas/api/schemas/trace/request/%/positions.metapack
...
( 15%) Producing: schemas/self/v1/schemas/mcp/error/%/positions.metapack
...
( 16%) Producing: schemas/self/v1/schemas/mcp/initialize/response/%/positions.metapack
...
( 17%) Producing: schemas/self/v1/schemas/mcp/notifications/initialized/%/positions.metapack
...
( 30%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/positions.metapack
...
( 36%) Producing: schemas/self/v1/schemas/meta/%/dependencies.metapack
( 36%) Producing: schemas/self/v1/schemas/meta/%/locations.metapack
( 36%) Producing: schemas/self/v1/schemas/meta/%/positions.metapack
( 36%) Producing: schemas/self/v1/schemas/meta/%/stats.metapack
...
( 42%) Producing: schemas/self/v1/schemas/mcp/ping/response/%/bundle.metapack
...
( 46%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-health/request/%/health.metapack
...
( 47%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-metadata/request/%/health.metapack
...
( 48%) Producing: schemas/self/v1/schemas/mcp/tools/call/get-schema-stats/request/%/health.metapack
...
( 50%) Producing: schemas/self/v1/schemas/mcp/tools/call/trace-schema-evaluation/request/%/bundle.metapack
...
( 51%) Producing: schemas/self/v1/schemas/meta/%/bundle.metapack
