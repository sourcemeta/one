...
Detecting: $(realpath "$TMP")/schemas/test.json (#31)
...
( 42%) Producing: schemas/self/v1/schemas/api/schemas/trace/request/%/bundle.metapack
...
( 51%) Producing: schemas/test/test/%/health.metapack
