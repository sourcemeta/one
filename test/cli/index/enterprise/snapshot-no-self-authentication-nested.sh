...
./explorer/public/group/%/login-html.metapack
...
./explorer/public/group/open/%/login-html.metapack
...
./explorer/public/group/open/nested/%/login-html.metapack
...
./explorer/public/loose/%/login-html.metapack
...
./explorer/vault/%/login-html.metapack
...
./explorer/vault/group/%/login-html.metapack
...
./explorer/vault/group/closed/%/login-html.metapack
...
./explorer/vault/group/closed/nested/%/login-html.metapack
...
./explorer/vault/group/open/%/login-html.metapack
...
./explorer/vault/group/open/nested/%/login-html.metapack
...
./explorer/vault/loose/%/login-html.metapack
