...
| `/description`  | String  | No  | None | A longer description of the schema collection. The web explorer renders this as [GitHub Flavored Markdown](https://github.github.com/gfm/) |
...
| `/x-sourcemeta-one:alert`      | String  | No  | N/A | When set, provide a human-readable alert on both the API and the HTML explorer for every schema in the collection. This is useful to provide any important message to consumers. The web explorer renders this as [GitHub Flavored Markdown](https://github.github.com/gfm/) |
