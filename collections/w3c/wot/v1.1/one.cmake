set(COLLECTION_NAMESPACE "w3c/wot/v1.1")
set(WOT_PATH "${PROJECT_SOURCE_DIR}/vendor/collections/wot/td/v1.1/validation")
...
install(FILES "${WOT_PATH}/tm-json-schema-validation.json"
  DESTINATION "${CMAKE_INSTALL_DATADIR}/sourcemeta/one/collections/${COLLECTION_NAMESPACE}/schemas"
  RENAME thing-model.json
  COMPONENT sourcemeta_one)
