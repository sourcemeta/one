set(COLLECTION_NAMESPACE "openapi/v3.1")
set(OPENAPI_PATH "${PROJECT_SOURCE_DIR}/vendor/collections/openapi/oas/3.1")
...
foreach(OPENAPI_DIRECTORY ${OPENAPI_DIRECTORIES})
  ...
  foreach(OPENAPI_FILE ${OPENAPI_FILES})
    ...
    install(FILES "${OPENAPI_FILE}"
      DESTINATION "${CMAKE_INSTALL_DATADIR}/sourcemeta/one/collections/${COLLECTION_NAMESPACE}/schemas/${OPENAPI_DIRECTORY}"
